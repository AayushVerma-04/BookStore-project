...
function Ee(r) {
  for (let t of r) switch (t.kind) {
    case "function": {
      ...
      t.value = le2(t.value), Ee(t.nodes);
      break;
    }
    case "separator":
    case "word": {
...
function* Qe(r, t) {
  ...
  let u2 = false;
  e[e.length - 1] === "!" ? (u2 = true, e = e.slice(0, -1)) : e[0] === "!" && (u2 = true, e = e.slice(1)), t.utilities.has(e, "static") && !e.includes("[") && (yield { kind: "static", root: e, variants: l3, important: u2, raw: r });
  let [s2, p2 = null, m] = u(e, "/");
  if (m) return;
  let f2 = p2 === null ? null : Ke(p2);
  if (p2 !== null && f2 === null) return;
  if (s2[0] === "[") {
    if (s2[s2.length - 1] !== "]") return;
    let g2 = s2.charCodeAt(1);
    if (g2 !== Ze && !(g2 >= He && g2 <= Xe)) return;
    s2 = s2.slice(1, -1);
    let h2 = s2.indexOf(":");
    if (h2 === -1 || h2 === 0 || h2 === s2.length - 1) return;
    let y3 = s2.slice(0, h2), b3 = H3(s2.slice(h2 + 1));
    yield { kind: "arbitrary", property: y3, value: b3, modifier: f2, variants: l3, important: u2, raw: r };
    return;
  }
  let d2;
  if (s2[s2.length - 1] === "]") {
    let g2 = s2.indexOf("-[");
    if (g2 === -1) return;
    let h2 = s2.slice(0, g2);
    if (!t.utilities.has(h2, "functional")) return;
    let y3 = s2.slice(g2 + 1);
    d2 = [[h2, y3]];
    ...
    let h2 = s2.slice(0, g2);
    if (!t.utilities.has(h2, "functional")) return;
    let y3 = s2.slice(g2 + 2, -1), b3 = u(y3, ":"), x = null;
    if (b3.length === 2 && (x = b3[0], y3 = b3[1]), y3[0] !== "-" && y3[1] !== "-") return;
    d2 = [[h2, x === null ? `[var(${y3})]` : `[${x}:var(${y3})]`]];
  } else d2 = tt(s2, (g2) => t.utilities.has(g2, "functional"));
  for (let [g2, h2] of d2) {
    let y3 = { kind: "functional", root: g2, modifier: f2, value: null, variants: l3, important: u2, raw: r };
    if (h2 === null) {
      yield y3;
      continue;
    }
    {
      ...
      if (b3 !== -1) {
        ...
        let V3 = H3(h2.slice(b3 + 1, -1)), k3 = "";
        for (let N3 = 0; N3 < V3.length; N3++) {
          let F3 = V3.charCodeAt(N3);
          if (F3 === Qt) {
            k3 = V3.slice(0, N3), V3 = V3.slice(N3 + 1);
            break;
          }
          if (!(F3 === Ze || F3 >= He && F3 <= Xe)) break;
        }
        if (V3.length === 0 || V3.trim().length === 0) continue;
        y3.value = { kind: "arbitrary", dataType: k3 || null, value: V3 };
      } else {
        let V3 = p2 === null || ((_a2 = y3.modifier) == null ? void 0 : _a2.kind) === "arbitrary" ? null : `${h2}/${p2}`;
        y3.value = { kind: "named", value: h2, fraction: V3 };
      }
    }
    yield y3;
  }
...
function et(r, t) {
  ...
  }
  {
    let [i, e = null, l3] = u(r, "/");
    if (l3) return null;
    let u2 = tt(i, (s2) => t.variants.has(s2));
    for (let [s2, p2] of u2) switch (t.variants.kind(s2)) {
      case "static":
      ...
      case "functional": {
        ...
        if (p2[p2.length - 1] === "]") {
          if (p2[0] !== "[") continue;
          let f2 = H3(p2.slice(1, -1));
          return f2.length === 0 || f2.trim().length === 0 ? null : { kind: "functional", root: s2, modifier: m, value: { kind: "arbitrary", value: f2 } };
        }
        if (p2[p2.length - 1] === ")") {
          if (p2[0] !== "(") continue;
          let f2 = H3(p2.slice(1, -1));
          return f2.length === 0 || f2.trim().length === 0 || f2[0] !== "-" && f2[1] !== "-" ? null : { kind: "functional", root: s2, modifier: m, value: { kind: "arbitrary", value: `var(${f2})` } };
        }
      ...
      case "compound": {
        ...
        let f2 = e === null ? null : Ke(e);
        return e !== null && f2 === null ? null : { kind: "compound", root: s2, modifier: f2, variant: m };
      }
    }
  }
  return null;
...
function te3(r, t, i) {
  if (r === t) return 0;
  let e = r.indexOf("("), l3 = t.indexOf("("), u2 = e === -1 ? r.replace(/[\d.]+/g, "") : r.slice(0, e), s2 = l3 === -1 ? t.replace(/[\d.]+/g, "") : t.slice(0, l3), p2 = (u2 === s2 ? 0 : u2 < s2 ? -1 : 1) || (i === "asc" ? parseInt(r) - parseInt(t) : parseInt(t) - parseInt(r));
  return Number.isNaN(p2) ? r < t ? -1 : 1 : p2;
}
var er = /* @__PURE__ */ new Set(["inset", "inherit", "initial", "revert", "unset"]);
var rt = /^-?(\d+|\.\d+)(.*?)$/g;
function re3(r, t) {
  return u(r, ",").map((e) => {
    e = e.trim();
    let l3 = u(e, " ").filter((f2) => f2.trim() !== ""), u2 = null, s2 = null, p2 = null;
    for (let f2 of l3) er.has(f2) || (rt.test(f2) ? (s2 === null ? s2 = f2 : p2 === null && (p2 = f2), rt.lastIndex = 0) : u2 === null && (u2 = f2));
    if (s2 === null || p2 === null) return e;
    let m = t(u2 ?? "currentcolor");
    return u2 !== null ? e.replace(u2, m) : `${e} ${m}`;
  }).join(", ");
}
var rr = /^-?[a-z][a-zA-Z0-9/%._-]*$/;
var nr = /^-?[a-z][a-zA-Z0-9/%._-]*-\*$/;
var je = class {
  constructor() {
  ...
  keys(t) {
    let i = [];
    for (let [e, l3] of this.utilities.entries()) for (let u2 of l3) if (u2.kind === t) {
      i.push(e);
      break;
    }
    return i;
...
function it(r) {
  ...
  function i(n, a) {
    let c = /(\d+)_(\d+)/g;
    function* w3($3) {
      for (let E3 of r.keysInNamespaces($3)) yield E3.replace(c, (C3, A3, U3) => `${A3}.${U3}`);
    }
    let v2 = ["1/2", "1/3", "2/3", "1/4", "2/4", "3/4", "1/5", "2/5", "3/5", "4/5", "1/6", "2/6", "3/6", "4/6", "5/6", "1/12", "2/12", "3/12", "4/12", "5/12", "6/12", "7/12", "8/12", "9/12", "10/12", "11/12"];
    t.suggest(n, () => {
      let $3 = [];
      for (let E3 of a()) {
        if (typeof E3 == "string") {
        ...
        let C3 = [...E3.values ?? [], ...w3(E3.valueThemeKeys ?? [])], A3 = [...E3.modifiers ?? [], ...w3(E3.modifierThemeKeys ?? [])];
        E3.supportsFractions && C3.push(...v2), E3.hasDefaultValue && C3.unshift(null), $3.push({ supportsNegative: E3.supportsNegative, values: C3, modifiers: A3 });
      }
      return $3;
    });
  }
  function e(n, a) {
    t.static(n, () => a.map((c) => typeof c == "function" ? c() : te2(c[0], c[1])));
  }
  function l3(n, a) {
    function c({ negative: w3 }) {
      return (v2) => {
        let $3 = null;
        if (v2.value) if (v2.value.kind === "arbitrary") {
          if (v2.modifier) return;
          $3 = v2.value.value;
        } else {
          if ($3 = r.resolve(v2.value.fraction ?? v2.value.value, a.themeKeys ?? []), $3 === null && a.supportsFractions && v2.value.fraction) {
            let [E3, C3] = u(v2.value.fraction, "/");
            if (!p(E3) || !p(C3)) return;
            $3 = `calc(${v2.value.fraction} * 100%)`;
          }
          if ($3 === null && w3 && a.handleNegativeBareValue) {
            if ($3 = a.handleNegativeBareValue(v2.value), !($3 == null ? void 0 : $3.includes("/")) && v2.modifier) return;
            if ($3 !== null) return a.handle($3);
          }
          if ($3 === null && a.handleBareValue && ($3 = a.handleBareValue(v2.value), !($3 == null ? void 0 : $3.includes("/")) && v2.modifier)) return;
        }
        else {
          if (v2.modifier) return;
          $3 = a.defaultValue !== void 0 ? a.defaultValue : r.resolve(null, a.themeKeys ?? []);
        }
        if ($3 !== null) return a.handle(w3 ? `calc(${$3} * -1)` : $3);
      };
    }
    a.supportsNegative && t.functional(`-${n}`, c({ negative: true })), t.functional(n, c({ negative: false })), i(n, () => [{ supportsNegative: a.supportsNegative, valueThemeKeys: a.themeKeys ?? [], hasDefaultValue: a.defaultValue !== void 0 && a.defaultValue !== null, supportsFractions: a.supportsFractions }]);
  }
  function u2(n, a) {
    t.functional(n, (c) => {
      if (!c.value) return;
      let w3 = null;
      if (c.value.kind === "arbitrary" ? (w3 = c.value.value, w3 = L3(w3, c.modifier, r)) : w3 = W3(c, r, a.themeKeys), w3 !== null) return a.handle(w3);
    }), i(n, () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: a.themeKeys, modifiers: Array.from({ length: 21 }, (c, w3) => `${w3 * 5}`) }]);
  }
  function s2(n, a, c, { supportsNegative: w3 = false, supportsFractions: v2 = false } = {}) {
    w3 && t.static(`-${n}-px`, () => c("-1px")), t.static(`${n}-px`, () => c("1px")), l3(n, { themeKeys: a, supportsFractions: v2, supportsNegative: w3, defaultValue: null, handleBareValue: ({ value: $3 }) => {
      let E3 = r.resolve(null, ["--spacing"]);
      return !E3 || !ue($3) ? null : `calc(${E3} * ${$3})`;
    }, handleNegativeBareValue: ({ value: $3 }) => {
      let E3 = r.resolve(null, ["--spacing"]);
      return !E3 || !ue($3) ? null : `calc(${E3} * -${$3})`;
    }, handle: c }), i(n, () => [{ values: r.get(["--spacing"]) ? ["0", "0.5", "1", "1.5", "2", "2.5", "3", "3.5", "4", "5", "6", "7", "8", "9", "10", "11", "12", "14", "16", "20", "24", "28", "32", "36", "40", "44", "48", "52", "56", "60", "64", "72", "80", "96"] : [], supportsNegative: w3, supportsFractions: v2, valueThemeKeys: a }]);
  }
  ...
  for (let [n, a] of [["inset", "inset"], ["inset-x", "inset-inline"], ["inset-y", "inset-block"], ["start", "inset-inline-start"], ["end", "inset-inline-end"], ["top", "top"], ["right", "right"], ["bottom", "bottom"], ["left", "left"]]) e(`${n}-auto`, [[a, "auto"]]), e(`${n}-full`, [[a, "100%"]]), e(`-${n}-full`, [[a, "-100%"]]), s2(n, ["--inset", "--spacing"], (c) => [te2(a, c)], { supportsNegative: true, supportsFractions: true });
  ...
  for (let [n, a] of [["m", "margin"], ["mx", "margin-inline"], ["my", "margin-block"], ["ms", "margin-inline-start"], ["me", "margin-inline-end"], ["mt", "margin-top"], ["mr", "margin-right"], ["mb", "margin-bottom"], ["ml", "margin-left"]]) e(`${n}-auto`, [[a, "auto"]]), s2(n, ["--margin", "--spacing"], (c) => [te2(a, c)], { supportsNegative: true });
  ...
  for (let [n, a, c] of [["w", ["--width", "--spacing", "--container"], "width"], ["min-w", ["--min-width", "--spacing", "--container"], "min-width"], ["max-w", ["--max-width", "--spacing", "--container"], "max-width"], ["h", ["--height", "--spacing"], "height"], ["min-h", ["--min-height", "--height", "--spacing"], "min-height"], ["max-h", ["--max-height", "--height", "--spacing"], "max-height"]]) s2(n, a, (w3) => [te2(c, w3)], { supportsFractions: true });
  t.static("container", () => {
    let n = [...r.namespace("--breakpoint").values()];
    n.sort((c, w3) => te3(c, w3, "asc"));
    let a = [te2("--tw-sort", "--tw-container-component"), te2("width", "100%")];
    for (let c of n) a.push(V2("@media", `(width >= ${c})`, [te2("max-width", c)]));
    return a;
    ...
    if (n.value) {
      ...
      if (n.value.fraction) {
        let [a, c] = u(n.value.fraction, "/");
        return !p(a) || !p(c) ? void 0 : [te2("flex", `calc(${n.value.fraction} * 100%)`)];
      }
  ...
  let p2 = () => De([T3("--tw-border-spacing-x", "0", "<length>"), T3("--tw-border-spacing-y", "0", "<length>")]);
  ...
  let m = () => De([T3("--tw-translate-x", "0"), T3("--tw-translate-y", "0"), T3("--tw-translate-z", "0")]);
  e("translate-none", [["translate", "none"]]), e("-translate-full", [m, ["--tw-translate-x", "-100%"], ["--tw-translate-y", "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e("translate-full", [m, ["--tw-translate-x", "100%"], ["--tw-translate-y", "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), s2("translate", ["--translate", "--spacing"], (n) => [m(), te2("--tw-translate-x", n), te2("--tw-translate-y", n), te2("translate", "var(--tw-translate-x) var(--tw-translate-y)")], { supportsNegative: true, supportsFractions: true });
  for (let n of ["x", "y"]) e(`-translate-${n}-full`, [m, [`--tw-translate-${n}`, "-100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), e(`translate-${n}-full`, [m, [`--tw-translate-${n}`, "100%"], ["translate", "var(--tw-translate-x) var(--tw-translate-y)"]]), s2(`translate-${n}`, ["--translate", "--spacing"], (a) => [m(), te2(`--tw-translate-${n}`, a), te2("translate", "var(--tw-translate-x) var(--tw-translate-y)")], { supportsNegative: true, supportsFractions: true });
  s2("translate-z", ["--translate", "--spacing"], (n) => [m(), te2("--tw-translate-z", n), te2("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)")], { supportsNegative: true }), e("translate-3d", [m, ["translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"]]);
  let f2 = () => De([T3("--tw-scale-x", "1"), T3("--tw-scale-y", "1"), T3("--tw-scale-z", "1")]);
  e("scale-none", [["scale", "none"]]);
  function d2({ negative: n }) {
    return (a) => {
      if (!a.value || a.modifier) return;
      let c;
      return a.value.kind === "arbitrary" ? (c = a.value.value, [te2("scale", c)]) : (c = r.resolve(a.value.value, ["--scale"]), !c && p(a.value.value) && (c = `${a.value.value}%`), c ? (c = n ? `calc(${c} * -1)` : c, [f2(), te2("--tw-scale-x", c), te2("--tw-scale-y", c), te2("--tw-scale-z", c), te2("scale", "var(--tw-scale-x) var(--tw-scale-y)")]) : void 0);
    };
  }
  ...
  for (let n of ["x", "y", "z"]) l3(`scale-${n}`, { supportsNegative: true, themeKeys: ["--scale"], handleBareValue: ({ value: a }) => p(a) ? `${a}%` : null, handle: (a) => [f2(), te2(`--tw-scale-${n}`, a), te2("scale", `var(--tw-scale-x) var(--tw-scale-y)${n === "z" ? " var(--tw-scale-z)" : ""}`)] }), i(`scale-${n}`, () => [{ supportsNegative: true, values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--scale"] }]);
  ...
  function g2({ negative: n }) {
    return (a) => {
      ...
      if (a.value.kind === "arbitrary") {
        c = a.value.value;
        let w3 = a.value.dataType ?? pe(c, ["angle", "vector"]);
        if (w3 === "vector") return [te2("rotate", `${c} var(--tw-rotate)`)];
        if (w3 !== "angle") return [te2("rotate", c)];
      } else if (c = r.resolve(a.value.value, ["--rotate"]), !c && p(a.value.value) && (c = `${a.value.value}deg`), !c) return;
      return [te2("rotate", n ? `calc(${c} * -1)` : c)];
    };
  }
  ...
  {
    let n = ["var(--tw-rotate-x)", "var(--tw-rotate-y)", "var(--tw-rotate-z)", "var(--tw-skew-x)", "var(--tw-skew-y)"].join(" "), a = () => De([T3("--tw-rotate-x", "rotateX(0)"), T3("--tw-rotate-y", "rotateY(0)"), T3("--tw-rotate-z", "rotateZ(0)"), T3("--tw-skew-x", "skewX(0)"), T3("--tw-skew-y", "skewY(0)")]);
    for (let c of ["x", "y", "z"]) l3(`rotate-${c}`, { supportsNegative: true, themeKeys: ["--rotate"], handleBareValue: ({ value: w3 }) => p(w3) ? `${w3}deg` : null, handle: (w3) => [a(), te2(`--tw-rotate-${c}`, `rotate${c.toUpperCase()}(${w3})`), te2("transform", n)] }), i(`rotate-${c}`, () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12", "45", "90", "180"], valueThemeKeys: ["--rotate"] }]);
    l3("skew", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: c }) => p(c) ? `${c}deg` : null, handle: (c) => [a(), te2("--tw-skew-x", `skewX(${c})`), te2("--tw-skew-y", `skewY(${c})`), te2("transform", n)] }), l3("skew-x", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: c }) => p(c) ? `${c}deg` : null, handle: (c) => [a(), te2("--tw-skew-x", `skewX(${c})`), te2("transform", n)] }), l3("skew-y", { supportsNegative: true, themeKeys: ["--skew"], handleBareValue: ({ value: c }) => p(c) ? `${c}deg` : null, handle: (c) => [a(), te2("--tw-skew-y", `skewY(${c})`), te2("transform", n)] }), i("skew", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-x", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), i("skew-y", () => [{ supportsNegative: true, values: ["0", "1", "2", "3", "6", "12"], valueThemeKeys: ["--skew"] }]), t.functional("transform", (c) => {
      if (c.modifier) return;
      let w3 = null;
      if (c.value ? c.value.kind === "arbitrary" && (w3 = c.value.value) : w3 = n, w3 !== null) return [a(), te2("transform", w3)];
  ...
  let h2 = () => De([T3("--tw-pan-x"), T3("--tw-pan-y"), T3("--tw-pinch-zoom")]);
  ...
  let y3 = () => De([T3("--tw-scroll-snap-strictness", "proximity", "*")]);
  ...
  e("border-solid", [["--tw-border-style", "solid"], ["border-style", "solid"]]), e("border-dashed", [["--tw-border-style", "dashed"], ["border-style", "dashed"]]), e("border-dotted", [["--tw-border-style", "dotted"], ["border-style", "dotted"]]), e("border-double", [["--tw-border-style", "double"], ["border-style", "double"]]), e("border-hidden", [["--tw-border-style", "hidden"], ["border-style", "hidden"]]), e("border-none", [["--tw-border-style", "none"], ["border-style", "none"]]);
  {
    let a = function(c, w3) {
      t.functional(c, (v2) => {
        if (!v2.value) {
          if (v2.modifier) return;
          let $3 = r.get(["--default-border-width"]) ?? "1px", E3 = w3.width($3);
          return E3 ? [n(), ...E3] : void 0;
        }
        if (v2.value.kind === "arbitrary") {
          let $3 = v2.value.value;
          switch (v2.value.dataType ?? pe($3, ["color", "line-width", "length"])) {
            case "line-width":
            case "length": {
              if (v2.modifier) return;
              let C3 = w3.width($3);
            ...
            default:
              return $3 = L3($3, v2.modifier, r), $3 === null ? void 0 : w3.color($3);
          }
        }
        {
          let $3 = W3(v2, r, ["--border-color", "--color"]);
          if ($3) return w3.color($3);
        }
        {
          if (v2.modifier) return;
          let $3 = r.resolve(v2.value.value, ["--border-width"]);
          if ($3) {
            let E3 = w3.width($3);
            return E3 ? [n(), ...E3] : void 0;
          }
          if (p(v2.value.value)) {
            let E3 = w3.width(`${v2.value.value}px`);
            return E3 ? [n(), ...E3] : void 0;
          }
        }
      }), i(c, () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--border-color", "--color"], modifiers: Array.from({ length: 21 }, (v2, $3) => `${$3 * 5}`), hasDefaultValue: true }, { values: ["0", "2", "4", "8"], valueThemeKeys: ["--border-width"] }]);
    };
    var V3 = a;
    let n = () => De([T3("--tw-border-style", "solid")]);
    a("border", { width: (c) => [te2("border-style", "var(--tw-border-style)"), te2("border-width", c)], color: (c) => [te2("border-color", c)] }), a("border-x", { width: (c) => [te2("border-inline-style", "var(--tw-border-style)"), te2("border-inline-width", c)], color: (c) => [te2("border-inline-color", c)] }), a("border-y", { width: (c) => [te2("border-block-style", "var(--tw-border-style)"), te2("border-block-width", c)], color: (c) => [te2("border-block-color", c)] }), a("border-s", { width: (c) => [te2("border-inline-start-style", "var(--tw-border-style)"), te2("border-inline-start-width", c)], color: (c) => [te2("border-inline-start-color", c)] }), a("border-e", { width: (c) => [te2("border-inline-end-style", "var(--tw-border-style)"), te2("border-inline-end-width", c)], color: (c) => [te2("border-inline-end-color", c)] }), a("border-t", { width: (c) => [te2("border-top-style", "var(--tw-border-style)"), te2("border-top-width", c)], color: (c) => [te2("border-top-color", c)] }), a("border-r", { width: (c) => [te2("border-right-style", "var(--tw-border-style)"), te2("border-right-width", c)], color: (c) => [te2("border-right-color", c)] }), a("border-b", { width: (c) => [te2("border-bottom-style", "var(--tw-border-style)"), te2("border-bottom-width", c)], color: (c) => [te2("border-bottom-color", c)] }), a("border-l", { width: (c) => [te2("border-left-style", "var(--tw-border-style)"), te2("border-left-width", c)], color: (c) => [te2("border-left-color", c)] }), l3("divide-x", { defaultValue: r.get(["--default-border-width"]) ?? "1px", themeKeys: ["--divide-width", "--border-width"], handleBareValue: ({ value: c }) => p(c) ? `${c}px` : null, handle: (c) => [De([T3("--tw-divide-x-reverse", "0")]), me(":where(& > :not(:last-child))", [te2("--tw-sort", "divide-x-width"), n(), te2("--tw-divide-x-reverse", "0"), te2("border-inline-style", "var(--tw-border-style)"), te2("border-inline-start-width", `calc(${c} * var(--tw-divide-x-reverse))`), te2("border-inline-end-width", `calc(${c} * calc(1 - var(--tw-divide-x-reverse)))`)])] }), l3("divide-y", { defaultValue: r.get(["--default-border-width"]) ?? "1px", themeKeys: ["--divide-width", "--border-width"], handleBareValue: ({ value: c }) => p(c) ? `${c}px` : null, handle: (c) => [De([T3("--tw-divide-y-reverse", "0")]), me(":where(& > :not(:last-child))", [te2("--tw-sort", "divide-y-width"), n(), te2("--tw-divide-y-reverse", "0"), te2("border-bottom-style", "var(--tw-border-style)"), te2("border-top-style", "var(--tw-border-style)"), te2("border-top-width", `calc(${c} * var(--tw-divide-y-reverse))`), te2("border-bottom-width", `calc(${c} * calc(1 - var(--tw-divide-y-reverse)))`)])] }), i("divide-x", () => [{ values: ["0", "2", "4", "8"], valueThemeKeys: ["--divide-width", "--border-width"], hasDefaultValue: true }]), i("divide-y", () => [{ values: ["0", "2", "4", "8"], valueThemeKeys: ["--divide-width", "--border-width"], hasDefaultValue: true }]), e("divide-x-reverse", [() => De([T3("--tw-divide-x-reverse", "0")]), () => me(":where(& > :not(:last-child))", [te2("--tw-divide-x-reverse", "1")])]), e("divide-y-reverse", [() => De([T3("--tw-divide-y-reverse", "0")]), () => me(":where(& > :not(:last-child))", [te2("--tw-divide-y-reverse", "1")])]);
    for (let c of ["solid", "dashed", "dotted", "double", "none"]) e(`divide-${c}`, [() => me(":where(& > :not(:last-child))", [te2("--tw-sort", "divide-style"), te2("--tw-border-style", c), te2("border-style", c)])]);
  }
  e("bg-auto", [["background-size", "auto"]]), e("bg-cover", [["background-size", "cover"]]), e("bg-contain", [["background-size", "contain"]]), e("bg-fixed", [["background-attachment", "fixed"]]), e("bg-local", [["background-attachment", "local"]]), e("bg-scroll", [["background-attachment", "scroll"]]), e("bg-center", [["background-position", "center"]]), e("bg-top", [["background-position", "top"]]), e("bg-right-top", [["background-position", "right top"]]), e("bg-right", [["background-position", "right"]]), e("bg-right-bottom", [["background-position", "right bottom"]]), e("bg-bottom", [["background-position", "bottom"]]), e("bg-left-bottom", [["background-position", "left bottom"]]), e("bg-left", [["background-position", "left"]]), e("bg-left-top", [["background-position", "left top"]]), e("bg-repeat", [["background-repeat", "repeat"]]), e("bg-no-repeat", [["background-repeat", "no-repeat"]]), e("bg-repeat-x", [["background-repeat", "repeat-x"]]), e("bg-repeat-y", [["background-repeat", "repeat-y"]]), e("bg-repeat-round", [["background-repeat", "round"]]), e("bg-repeat-space", [["background-repeat", "space"]]), e("bg-none", [["background-image", "none"]]);
  {
    let c = function($3) {
      ...
      return (E3) => {
        ...
        let A3 = c(E3.modifier);
        return [te2("--tw-gradient-position", `${C3} ${A3}`), te2("background-image", "linear-gradient(var(--tw-gradient-stops))")];
      };
    }, v2 = function({ negative: $3 }) {
      return (E3) => {
        var _a2;
        ...
        let C3 = c(E3.modifier);
        if (!E3.value) return [te2("--tw-gradient-position", C3), te2("background-image", "conic-gradient(var(--tw-gradient-stops))")];
        let A3 = E3.value.value;
        if (p(A3)) return A3 = $3 ? `calc(${A3} * -1)` : `${A3}deg`, [te2("--tw-gradient-position", `from ${A3} ${C3}`), te2("background-image", "conic-gradient(var(--tw-gradient-stops))")];
      };
    };
    var k3 = c, N3 = w3, F3 = v2;
    ...
    t.functional("-bg-linear", w3({ negative: true })), t.functional("bg-linear", w3({ negative: false })), i("bg-linear", () => [{ values: [...a.keys()], modifiers: n }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: n }]), t.functional("-bg-conic", v2({ negative: true })), t.functional("bg-conic", v2({ negative: false })), i("bg-conic", () => [{ hasDefaultValue: true, modifiers: n }, { values: ["0", "30", "60", "90", "120", "150", "180", "210", "240", "270", "300", "330"], supportsNegative: true, modifiers: n }]), t.functional("bg-radial", ($3) => {
      if (!$3.value) {
        let E3 = c($3.modifier);
  ...
  let b3 = () => De([T3("--tw-gradient-position"), T3("--tw-gradient-from", "#0000", "<color>"), T3("--tw-gradient-via", "#0000", "<color>"), T3("--tw-gradient-to", "#0000", "<color>"), T3("--tw-gradient-stops"), T3("--tw-gradient-via-stops"), T3("--tw-gradient-from-position", "0%", "<length-percentage>"), T3("--tw-gradient-via-position", "50%", "<length-percentage>"), T3("--tw-gradient-to-position", "100%", "<length-percentage>")]);
  function x(n, a) {
    t.functional(n, (c) => {
      if (c.value) {
        if (c.value.kind === "arbitrary") {
          let w3 = c.value.value;
          switch (c.value.dataType ?? pe(w3, ["color", "length", "percentage"])) {
            case "length":
            case "percentage":
              return c.modifier ? void 0 : a.position(w3);
            default:
              return w3 = L3(w3, c.modifier, r), w3 === null ? void 0 : a.color(w3);
          }
        }
        {
          let w3 = W3(c, r, ["--background-color", "--color"]);
          if (w3) return a.color(w3);
        }
        {
          if (c.modifier) return;
          let w3 = r.resolve(c.value.value, ["--gradient-color-stop-positions"]);
          if (w3) return a.position(w3);
          if (c.value.value[c.value.value.length - 1] === "%" && p(c.value.value.slice(0, -1))) return a.position(c.value.value);
        }
      }
    }), i(n, () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--background-color", "--color"], modifiers: Array.from({ length: 21 }, (c, w3) => `${w3 * 5}`) }, { values: Array.from({ length: 21 }, (c, w3) => `${w3 * 5}%`), valueThemeKeys: ["--gradient-color-stop-positions"] }]);
  }
  x("from", { color: (n) => [b3(), te2("--tw-sort", "--tw-gradient-from"), te2("--tw-gradient-from", n), te2("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (n) => [b3(), te2("--tw-gradient-from-position", n)] }), e("via-none", [["--tw-gradient-via-stops", "initial"]]), x("via", { color: (n) => [b3(), te2("--tw-sort", "--tw-gradient-via"), te2("--tw-gradient-via", n), te2("--tw-gradient-via-stops", "var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-via) var(--tw-gradient-via-position), var(--tw-gradient-to) var(--tw-gradient-to-position)"), te2("--tw-gradient-stops", "var(--tw-gradient-via-stops)")], position: (n) => [b3(), te2("--tw-gradient-via-position", n)] }), x("to", { color: (n) => [b3(), te2("--tw-sort", "--tw-gradient-to"), te2("--tw-gradient-to", n), te2("--tw-gradient-stops", "var(--tw-gradient-via-stops, var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))")], position: (n) => [b3(), te2("--tw-gradient-to-position", n)] }), e("box-decoration-slice", [["-webkit-box-decoration-break", "slice"], ["box-decoration-break", "slice"]]), e("box-decoration-clone", [["-webkit-box-decoration-break", "clone"], ["box-decoration-break", "clone"]]), e("bg-clip-text", [["background-clip", "text"]]), e("bg-clip-border", [["background-clip", "border-box"]]), e("bg-clip-padding", [["background-clip", "padding-box"]]), e("bg-clip-content", [["background-clip", "content-box"]]), e("bg-origin-border", [["background-origin", "border-box"]]), e("bg-origin-padding", [["background-origin", "padding-box"]]), e("bg-origin-content", [["background-origin", "content-box"]]);
  ...
  e("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]), e("mix-blend-plus-lighter", [["mix-blend-mode", "plus-lighter"]]), e("fill-none", [["fill", "none"]]), t.functional("fill", (n) => {
    if (!n.value) return;
    if (n.value.kind === "arbitrary") {
      let c = L3(n.value.value, n.modifier, r);
      return c === null ? void 0 : [te2("fill", c)];
    }
  ...
  for (let [n, a] of [["p", "padding"], ["px", "padding-inline"], ["py", "padding-block"], ["ps", "padding-inline-start"], ["pe", "padding-inline-end"], ["pt", "padding-top"], ["pr", "padding-right"], ["pb", "padding-bottom"], ["pl", "padding-left"]]) s2(n, ["--padding", "--spacing"], (c) => [te2(a, c)]);
    ...
    if (!(!n.value || n.modifier)) {
      if (n.value.kind === "arbitrary") {
        ...
        switch (n.value.dataType ?? pe(a, ["number", "generic-name", "family-name"])) {
          ...
          default:
            return [De([T3("--tw-font-weight")]), te2("--tw-font-weight", a), te2("font-weight", a)];
        }
      }
      {
        ...
        if (a) {
          let [c, w3 = {}] = a;
          return [te2("font-family", c), te2("font-feature-settings", w3["--font-feature-settings"]), te2("font-variation-settings", w3["--font-variation-settings"])];
        }
      }
      {
        let a = r.resolve(n.value.value, ["--font-weight"]);
        if (a) return [De([T3("--tw-font-weight")]), te2("--tw-font-weight", a), te2("font-weight", a)];
      }
    }
  ...
  {
    let n = ["var(--tw-blur,)", "var(--tw-brightness,)", "var(--tw-contrast,)", "var(--tw-grayscale,)", "var(--tw-hue-rotate,)", "var(--tw-invert,)", "var(--tw-saturate,)", "var(--tw-sepia,)", "var(--tw-drop-shadow,)"].join(" "), a = ["var(--tw-backdrop-blur,)", "var(--tw-backdrop-brightness,)", "var(--tw-backdrop-contrast,)", "var(--tw-backdrop-grayscale,)", "var(--tw-backdrop-hue-rotate,)", "var(--tw-backdrop-invert,)", "var(--tw-backdrop-opacity,)", "var(--tw-backdrop-saturate,)", "var(--tw-backdrop-sepia,)"].join(" "), c = () => De([T3("--tw-blur"), T3("--tw-brightness"), T3("--tw-contrast"), T3("--tw-grayscale"), T3("--tw-hue-rotate"), T3("--tw-invert"), T3("--tw-opacity"), T3("--tw-saturate"), T3("--tw-sepia"), T3("--tw-drop-shadow")]), w3 = () => De([T3("--tw-backdrop-blur"), T3("--tw-backdrop-brightness"), T3("--tw-backdrop-contrast"), T3("--tw-backdrop-grayscale"), T3("--tw-backdrop-hue-rotate"), T3("--tw-backdrop-invert"), T3("--tw-backdrop-opacity"), T3("--tw-backdrop-saturate"), T3("--tw-backdrop-sepia")]);
    t.functional("filter", (v2) => {
      if (!v2.modifier) {
        if (v2.value === null) return [c(), te2("filter", n)];
        if (v2.value.kind === "arbitrary") return [te2("filter", v2.value.value)];
        switch (v2.value.value) {
          case "none":
            return [te2("filter", "none")];
        }
      }
    }), t.functional("backdrop-filter", (v2) => {
      if (!v2.modifier) {
        if (v2.value === null) return [w3(), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)];
        if (v2.value.kind === "arbitrary") return [te2("-webkit-backdrop-filter", v2.value.value), te2("backdrop-filter", v2.value.value)];
        switch (v2.value.value) {
          case "none":
            return [te2("-webkit-backdrop-filter", "none"), te2("backdrop-filter", "none")];
        }
      }
    }), l3("blur", { themeKeys: ["--blur"], handle: (v2) => [c(), te2("--tw-blur", `blur(${v2})`), te2("filter", n)] }), e("blur-none", [c, ["--tw-blur", " "], ["filter", n]]), l3("backdrop-blur", { themeKeys: ["--backdrop-blur", "--blur"], handle: (v2) => [w3(), te2("--tw-backdrop-blur", `blur(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), e("backdrop-blur-none", [w3, ["--tw-backdrop-blur", " "], ["-webkit-backdrop-filter", a], ["backdrop-filter", a]]), l3("brightness", { themeKeys: ["--brightness"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, handle: (v2) => [c(), te2("--tw-brightness", `brightness(${v2})`), te2("filter", n)] }), l3("backdrop-brightness", { themeKeys: ["--backdrop-brightness", "--brightness"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, handle: (v2) => [w3(), te2("--tw-backdrop-brightness", `brightness(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--brightness"] }]), i("backdrop-brightness", () => [{ values: ["0", "50", "75", "90", "95", "100", "105", "110", "125", "150", "200"], valueThemeKeys: ["--backdrop-brightness", "--brightness"] }]), l3("contrast", { themeKeys: ["--contrast"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, handle: (v2) => [c(), te2("--tw-contrast", `contrast(${v2})`), te2("filter", n)] }), l3("backdrop-contrast", { themeKeys: ["--backdrop-contrast", "--contrast"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, handle: (v2) => [w3(), te2("--tw-backdrop-contrast", `contrast(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--contrast"] }]), i("backdrop-contrast", () => [{ values: ["0", "50", "75", "100", "125", "150", "200"], valueThemeKeys: ["--backdrop-contrast", "--contrast"] }]), l3("grayscale", { themeKeys: ["--grayscale"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, defaultValue: "100%", handle: (v2) => [c(), te2("--tw-grayscale", `grayscale(${v2})`), te2("filter", n)] }), l3("backdrop-grayscale", { themeKeys: ["--backdrop-grayscale", "--grayscale"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, defaultValue: "100%", handle: (v2) => [w3(), te2("--tw-backdrop-grayscale", `grayscale(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--grayscale"], hasDefaultValue: true }]), i("backdrop-grayscale", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-grayscale", "--grayscale"], hasDefaultValue: true }]), l3("hue-rotate", { supportsNegative: true, themeKeys: ["--hue-rotate"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}deg` : null, handle: (v2) => [c(), te2("--tw-hue-rotate", `hue-rotate(${v2})`), te2("filter", n)] }), l3("backdrop-hue-rotate", { supportsNegative: true, themeKeys: ["--backdrop-hue-rotate", "--hue-rotate"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}deg` : null, handle: (v2) => [w3(), te2("--tw-backdrop-hue-rotate", `hue-rotate(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--hue-rotate"] }]), i("backdrop-hue-rotate", () => [{ values: ["0", "15", "30", "60", "90", "180"], valueThemeKeys: ["--backdrop-hue-rotate", "--hue-rotate"] }]), l3("invert", { themeKeys: ["--invert"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, defaultValue: "100%", handle: (v2) => [c(), te2("--tw-invert", `invert(${v2})`), te2("filter", n)] }), l3("backdrop-invert", { themeKeys: ["--backdrop-invert", "--invert"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, defaultValue: "100%", handle: (v2) => [w3(), te2("--tw-backdrop-invert", `invert(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--invert"], hasDefaultValue: true }]), i("backdrop-invert", () => [{ values: ["0", "25", "50", "75", "100"], valueThemeKeys: ["--backdrop-invert", "--invert"], hasDefaultValue: true }]), l3("saturate", { themeKeys: ["--saturate"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, handle: (v2) => [c(), te2("--tw-saturate", `saturate(${v2})`), te2("filter", n)] }), l3("backdrop-saturate", { themeKeys: ["--backdrop-saturate", "--saturate"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, handle: (v2) => [w3(), te2("--tw-backdrop-saturate", `saturate(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--saturate"] }]), i("backdrop-saturate", () => [{ values: ["0", "50", "100", "150", "200"], valueThemeKeys: ["--backdrop-saturate", "--saturate"] }]), l3("sepia", { themeKeys: ["--sepia"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, defaultValue: "100%", handle: (v2) => [c(), te2("--tw-sepia", `sepia(${v2})`), te2("filter", n)] }), l3("backdrop-sepia", { themeKeys: ["--backdrop-sepia", "--sepia"], handleBareValue: ({ value: v2 }) => p(v2) ? `${v2}%` : null, defaultValue: "100%", handle: (v2) => [w3(), te2("--tw-backdrop-sepia", `sepia(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--sepia"], hasDefaultValue: true }]), i("backdrop-sepia", () => [{ values: ["0", "50", "100"], valueThemeKeys: ["--backdrop-sepia", "--sepia"], hasDefaultValue: true }]), e("drop-shadow-none", [c, ["--tw-drop-shadow", " "], ["filter", n]]), l3("drop-shadow", { themeKeys: ["--drop-shadow"], handle: (v2) => [c(), te2("--tw-drop-shadow", u(v2, ",").map(($3) => `drop-shadow(${$3})`).join(" ")), te2("filter", n)] }), l3("backdrop-opacity", { themeKeys: ["--backdrop-opacity", "--opacity"], handleBareValue: ({ value: v2 }) => de(v2) ? `${v2}%` : null, handle: (v2) => [w3(), te2("--tw-backdrop-opacity", `opacity(${v2})`), te2("-webkit-backdrop-filter", a), te2("backdrop-filter", a)] }), i("backdrop-opacity", () => [{ values: Array.from({ length: 21 }, (v2, $3) => `${$3 * 5}`), valueThemeKeys: ["--backdrop-opacity", "--opacity"] }]);
  }
  {
    ...
    e("transition-none", [["transition-property", "none"]]), e("transition-all", [["transition-property", "all"], ["transition-timing-function", n], ["transition-duration", a]]), e("transition-colors", [["transition-property", "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to"], ["transition-timing-function", n], ["transition-duration", a]]), e("transition-opacity", [["transition-property", "opacity"], ["transition-timing-function", n], ["transition-duration", a]]), e("transition-shadow", [["transition-property", "box-shadow"], ["transition-timing-function", n], ["transition-duration", a]]), e("transition-transform", [["transition-property", "transform, translate, scale, rotate"], ["transition-timing-function", n], ["transition-duration", a]]), l3("transition", { defaultValue: "color, background-color, border-color, outline-color, text-decoration-color, fill, stroke, --tw-gradient-from, --tw-gradient-via, --tw-gradient-to, opacity, box-shadow, transform, translate, scale, rotate, filter, -webkit-backdrop-filter, backdrop-filter", themeKeys: ["--transition-property"], handle: (c) => [te2("transition-property", c), te2("transition-timing-function", n), te2("transition-duration", a)] }), e("transition-discrete", [["transition-behavior", "allow-discrete"]]), e("transition-normal", [["transition-behavior", "normal"]]), l3("delay", { handleBareValue: ({ value: c }) => p(c) ? `${c}ms` : null, themeKeys: ["--transition-delay"], handle: (c) => [te2("transition-delay", c)] });
    {
      let c = () => De([T3("--tw-duration")]);
      e("duration-initial", [c, ["--tw-duration", "initial"]]), t.functional("duration", (w3) => {
        if (w3.modifier || !w3.value) return;
        let v2 = null;
        if (w3.value.kind === "arbitrary" ? v2 = w3.value.value : (v2 = r.resolve(w3.value.fraction ?? w3.value.value, ["--transition-duration"]), v2 === null && p(w3.value.value) && (v2 = `${w3.value.value}ms`)), v2 !== null) return [c(), te2("--tw-duration", v2), te2("transition-duration", v2)];
      });
    }
  ...
  e("will-change-auto", [["will-change", "auto"]]), e("will-change-scroll", [["will-change", "scroll-position"]]), e("will-change-contents", [["will-change", "contents"]]), e("will-change-transform", [["will-change", "transform"]]), l3("will-change", { themeKeys: [], handle: (n) => [te2("will-change", n)] }), e("content-none", [["--tw-content", "none"], ["content", "none"]]), l3("content", { themeKeys: [], handle: (n) => [De([T3("--tw-content", '""')]), te2("--tw-content", n), te2("content", "var(--tw-content)")] });
  {
    let n = "var(--tw-contain-size,) var(--tw-contain-layout,) var(--tw-contain-paint,) var(--tw-contain-style,)", a = () => De([T3("--tw-contain-size"), T3("--tw-contain-layout"), T3("--tw-contain-paint"), T3("--tw-contain-style")]);
    e("contain-none", [["contain", "none"]]), e("contain-content", [["contain", "content"]]), e("contain-strict", [["contain", "strict"]]), e("contain-size", [a, ["--tw-contain-size", "size"], ["contain", n]]), e("contain-inline-size", [a, ["--tw-contain-size", "inline-size"], ["contain", n]]), e("contain-layout", [a, ["--tw-contain-layout", "layout"], ["contain", n]]), e("contain-paint", [a, ["--tw-contain-paint", "paint"], ["contain", n]]), e("contain-style", [a, ["--tw-contain-style", "style"], ["contain", n]]), l3("contain", { themeKeys: [], handle: (c) => [te2("contain", c)] });
  }
  e("forced-color-adjust-none", [["forced-color-adjust", "none"]]), e("forced-color-adjust-auto", [["forced-color-adjust", "auto"]]), e("leading-none", [() => De([T3("--tw-leading")]), ["--tw-leading", "1"], ["line-height", "1"]]), s2("leading", ["--leading", "--spacing"], (n) => [De([T3("--tw-leading")]), te2("--tw-leading", n), te2("line-height", n)]), l3("tracking", { supportsNegative: true, themeKeys: ["--tracking"], handle: (n) => [De([T3("--tw-tracking")]), te2("--tw-tracking", n), te2("letter-spacing", n)] }), e("antialiased", [["-webkit-font-smoothing", "antialiased"], ["-moz-osx-font-smoothing", "grayscale"]]), e("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], ["-moz-osx-font-smoothing", "auto"]]);
  {
    let n = "var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)", a = () => De([T3("--tw-ordinal"), T3("--tw-slashed-zero"), T3("--tw-numeric-figure"), T3("--tw-numeric-spacing"), T3("--tw-numeric-fraction")]);
  ...
  {
    let n = () => De([T3("--tw-outline-style", "solid")]);
    t.static("outline-hidden", () => [te2("--tw-outline-style", "none"), te2("outline-style", "none"), V2("@media", "(forced-colors: active)", [te2("outline", "2px solid transparent"), te2("outline-offset", "2px")])]), e("outline-none", [["--tw-outline-style", "none"], ["outline-style", "none"]]), e("outline-solid", [["--tw-outline-style", "solid"], ["outline-style", "solid"]]), e("outline-dashed", [["--tw-outline-style", "dashed"], ["outline-style", "dashed"]]), e("outline-dotted", [["--tw-outline-style", "dotted"], ["outline-style", "dotted"]]), e("outline-double", [["--tw-outline-style", "double"], ["outline-style", "double"]]), t.functional("outline", (a) => {
      if (a.value === null) {
        ...
        let c = r.get(["--default-outline-width"]) ?? "1px";
        return [n(), te2("outline-style", "var(--tw-outline-style)"), te2("outline-width", c)];
      }
      if (a.value.kind === "arbitrary") {
        let c = a.value.value;
        switch (a.value.dataType ?? pe(c, ["color", "length", "number", "percentage"])) {
          case "length":
          case "number":
          case "percentage":
            return a.modifier ? void 0 : [n(), te2("outline-style", "var(--tw-outline-style)"), te2("outline-width", c)];
          default:
            return c = L3(c, a.modifier, r), c === null ? void 0 : [te2("outline-color", c)];
        }
      }
      {
        let c = W3(a, r, ["--outline-color", "--color"]);
        if (c) return [te2("outline-color", c)];
      }
      {
        if (a.modifier) return;
        let c = r.resolve(a.value.value, ["--outline-width"]);
        if (c) return [n(), te2("outline-style", "var(--tw-outline-style)"), te2("outline-width", c)];
        if (p(a.value.value)) return [n(), te2("outline-style", "var(--tw-outline-style)"), te2("outline-width", `${a.value.value}px`)];
      }
    }), i("outline", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--outline-color", "--color"], modifiers: Array.from({ length: 21 }, (a, c) => `${c * 5}`), hasDefaultValue: true }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--outline-width"] }]), l3("outline-offset", { supportsNegative: true, themeKeys: ["--outline-offset"], handleBareValue: ({ value: a }) => p(a) ? `${a}px` : null, handle: (a) => [te2("outline-offset", a)] }), i("outline-offset", () => [{ supportsNegative: true, values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--outline-offset"] }]);
  }
  l3("opacity", { themeKeys: ["--opacity"], handleBareValue: ({ value: n }) => de(n) ? `${n}%` : null, handle: (n) => [te2("opacity", n)] }), i("opacity", () => [{ values: Array.from({ length: 21 }, (n, a) => `${a * 5}`), valueThemeKeys: ["--opacity"] }]), e("underline-offset-auto", [["text-underline-offset", "auto"]]), l3("underline-offset", { supportsNegative: true, themeKeys: ["--text-underline-offset"], handleBareValue: ({ value: n }) => p(n) ? `${n}px` : null, handle: (n) => [te2("text-underline-offset", n)] }), i("underline-offset", () => [{ supportsNegative: true, values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--text-underline-offset"] }]), t.functional("text", (n) => {
    if (n.value) {
          ...
          case "relative-size": {
            if (n.modifier) {
              ...
              if (!w3 && ue(n.modifier.value)) {
                let v2 = r.resolve(null, ["--spacing"]);
                if (!v2) return null;
                w3 = `calc(${v2} * ${n.modifier.value})`;
              }
              return !w3 && n.modifier.value === "none" && (w3 = "1"), w3 ? [te2("font-size", a), te2("line-height", w3)] : null;
            }
      ...
      }
      {
        ...
        if (a) {
          let [c, w3 = {}] = Array.isArray(a) ? a : [a];
          if (n.modifier) {
            let v2 = n.modifier.kind === "arbitrary" ? n.modifier.value : r.resolve(n.modifier.value, ["--leading"]);
            if (!v2 && ue(n.modifier.value)) {
              let E3 = r.resolve(null, ["--spacing"]);
              if (!E3) return null;
              v2 = `calc(${E3} * ${n.modifier.value})`;
            }
            if (!v2 && n.modifier.value === "none" && (v2 = "1"), !v2) return null;
            let $3 = [te2("font-size", c)];
            return v2 && $3.push(te2("line-height", v2)), $3;
          }
          return typeof w3 == "string" ? [te2("font-size", c), te2("line-height", w3)] : [te2("font-size", c), te2("line-height", w3["--line-height"] ? `var(--tw-leading, ${w3["--line-height"]})` : void 0), te2("letter-spacing", w3["--letter-spacing"] ? `var(--tw-tracking, ${w3["--letter-spacing"]})` : void 0), te2("font-weight", w3["--font-weight"] ? `var(--tw-font-weight, ${w3["--font-weight"]})` : void 0)];
        }
      }
    }
  ...
  {
    let v2 = function(C3) {
      return `var(--tw-ring-inset,) 0 0 0 calc(${C3} + var(--tw-ring-offset-width)) var(--tw-ring-color, ${w3})`;
    }, $3 = function(C3) {
      return `inset 0 0 0 ${C3} var(--tw-inset-ring-color, currentColor)`;
    };
    var R3 = v2, D3 = $3;
    let n = ["var(--tw-inset-shadow)", "var(--tw-inset-ring-shadow)", "var(--tw-ring-offset-shadow)", "var(--tw-ring-shadow)", "var(--tw-shadow)"].join(", "), a = "0 0 #0000", c = () => De([T3("--tw-shadow", a), T3("--tw-shadow-color"), T3("--tw-inset-shadow", a), T3("--tw-inset-shadow-color"), T3("--tw-ring-color"), T3("--tw-ring-shadow", a), T3("--tw-inset-ring-color"), T3("--tw-inset-ring-shadow", a), T3("--tw-ring-inset"), T3("--tw-ring-offset-width", "0px", "<length>"), T3("--tw-ring-offset-color", "#fff"), T3("--tw-ring-offset-shadow", a)]);
    e("shadow-initial", [c, ["--tw-shadow-color", "initial"]]), t.functional("shadow", (C3) => {
      if (!C3.value) {
        let A3 = r.get(["--shadow"]);
        return A3 === null ? void 0 : [c(), te2("--tw-shadow", re3(A3, (U3) => `var(--tw-shadow-color, ${U3})`)), te2("box-shadow", n)];
      }
      if (C3.value.kind === "arbitrary") {
        let A3 = C3.value.value;
        switch (C3.value.dataType ?? pe(A3, ["color"])) {
          case "color":
            return A3 = L3(A3, C3.modifier, r), A3 === null ? void 0 : [c(), te2("--tw-shadow-color", A3)];
          default:
            return [c(), te2("--tw-shadow", re3(A3, (be) => `var(--tw-shadow-color, ${be})`)), te2("box-shadow", n)];
        }
      }
      switch (C3.value.value) {
        case "none":
          return C3.modifier ? void 0 : [c(), te2("--tw-shadow", a), te2("box-shadow", n)];
      }
      {
        let A3 = r.get([`--shadow-${C3.value.value}`]);
        if (A3) return C3.modifier ? void 0 : [c(), te2("--tw-shadow", re3(A3, (U3) => `var(--tw-shadow-color, ${U3})`)), te2("box-shadow", n)];
      }
      {
        let A3 = W3(C3, r, ["--box-shadow-color", "--color"]);
        if (A3) return [c(), te2("--tw-shadow-color", A3)];
      }
    }), i("shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (C3, A3) => `${A3 * 5}`) }, { values: ["none"], valueThemeKeys: ["--shadow"], hasDefaultValue: true }]), e("inset-shadow-initial", [c, ["--tw-inset-shadow-color", "initial"]]), t.functional("inset-shadow", (C3) => {
      if (!C3.value) {
        let A3 = r.get(["--inset-shadow"]);
        return A3 === null ? void 0 : [c(), te2("--tw-inset-shadow", re3(A3, (U3) => `var(--tw-inset-shadow-color, ${U3})`)), te2("box-shadow", n)];
      }
      if (C3.value.kind === "arbitrary") {
        let A3 = C3.value.value;
        switch (C3.value.dataType ?? pe(A3, ["color"])) {
          case "color":
            return A3 = L3(A3, C3.modifier, r), A3 === null ? void 0 : [c(), te2("--tw-inset-shadow-color", A3)];
          default:
            return [c(), te2("--tw-inset-shadow", `inset ${re3(A3, (be) => `var(--tw-inset-shadow-color, ${be})`)}`), te2("box-shadow", n)];
        }
      }
      switch (C3.value.value) {
        case "none":
          return C3.modifier ? void 0 : [c(), te2("--tw-inset-shadow", a), te2("box-shadow", n)];
      }
      {
        let A3 = r.get([`--inset-shadow-${C3.value.value}`]);
        if (A3) return C3.modifier ? void 0 : [c(), te2("--tw-inset-shadow", re3(A3, (U3) => `var(--tw-inset-shadow-color, ${U3})`)), te2("box-shadow", n)];
      }
      {
        let A3 = W3(C3, r, ["--box-shadow-color", "--color"]);
        if (A3) return [c(), te2("--tw-inset-shadow-color", A3)];
      }
    }), i("inset-shadow", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--box-shadow-color", "--color"], modifiers: Array.from({ length: 21 }, (C3, A3) => `${A3 * 5}`) }, { values: [], valueThemeKeys: ["--inset-shadow"], hasDefaultValue: true }]), e("ring-inset", [c, ["--tw-ring-inset", "inset"]]);
    let w3 = r.get(["--default-ring-color"]) ?? "currentColor";
    t.functional("ring", (C3) => {
      if (!C3.value) {
        if (C3.modifier) return;
        let A3 = r.get(["--default-ring-width"]) ?? "1px";
        return [c(), te2("--tw-ring-shadow", v2(A3)), te2("box-shadow", n)];
      }
      if (C3.value.kind === "arbitrary") {
        let A3 = C3.value.value;
        switch (C3.value.dataType ?? pe(A3, ["color", "length"])) {
          case "length":
            return C3.modifier ? void 0 : [c(), te2("--tw-ring-shadow", v2(A3)), te2("box-shadow", n)];
          default:
            return A3 = L3(A3, C3.modifier, r), A3 === null ? void 0 : [te2("--tw-ring-color", A3)];
        }
      }
      {
        let A3 = W3(C3, r, ["--ring-color", "--color"]);
        if (A3) return [te2("--tw-ring-color", A3)];
      }
      {
        if (C3.modifier) return;
        let A3 = r.resolve(C3.value.value, ["--ring-width"]);
        if (A3 === null && p(C3.value.value) && (A3 = `${C3.value.value}px`), A3) return [c(), te2("--tw-ring-shadow", v2(A3)), te2("box-shadow", n)];
      }
    }), i("ring", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--ring-color", "--color"], modifiers: Array.from({ length: 21 }, (C3, A3) => `${A3 * 5}`) }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--ring-width"], hasDefaultValue: true }]), t.functional("inset-ring", (C3) => {
      if (!C3.value) return C3.modifier ? void 0 : [c(), te2("--tw-inset-ring-shadow", $3("1px")), te2("box-shadow", n)];
      if (C3.value.kind === "arbitrary") {
        let A3 = C3.value.value;
        switch (C3.value.dataType ?? pe(A3, ["color", "length"])) {
          case "length":
            return C3.modifier ? void 0 : [c(), te2("--tw-inset-ring-shadow", $3(A3)), te2("box-shadow", n)];
          default:
            return A3 = L3(A3, C3.modifier, r), A3 === null ? void 0 : [te2("--tw-inset-ring-color", A3)];
        }
      }
      {
        let A3 = W3(C3, r, ["--ring-color", "--color"]);
        if (A3) return [te2("--tw-inset-ring-color", A3)];
      }
      {
        if (C3.modifier) return;
        let A3 = r.resolve(C3.value.value, ["--ring-width"]);
        if (A3 === null && p(C3.value.value) && (A3 = `${C3.value.value}px`), A3) return [c(), te2("--tw-inset-ring-shadow", $3(A3)), te2("box-shadow", n)];
      }
    }), i("inset-ring", () => [{ values: ["current", "inherit", "transparent"], valueThemeKeys: ["--ring-color", "--color"], modifiers: Array.from({ length: 21 }, (C3, A3) => `${A3 * 5}`) }, { values: ["0", "1", "2", "4", "8"], valueThemeKeys: ["--ring-width"], hasDefaultValue: true }]);
    ...
    t.functional("ring-offset", (C3) => {
      if (C3.value) {
        if (C3.value.kind === "arbitrary") {
          ...
          switch (C3.value.dataType ?? pe(A3, ["color", "length"])) {
            case "length":
              return C3.modifier ? void 0 : [te2("--tw-ring-offset-width", A3), te2("--tw-ring-offset-shadow", E3)];
            default:
              return A3 = L3(A3, C3.modifier, r), A3 === null ? void 0 : [te2("--tw-ring-offset-color", A3)];
          }
        }
        {
          let A3 = r.resolve(C3.value.value, ["--ring-offset-width"]);
          if (A3) return C3.modifier ? void 0 : [te2("--tw-ring-offset-width", A3), te2("--tw-ring-offset-shadow", E3)];
          if (p(C3.value.value)) return C3.modifier ? void 0 : [te2("--tw-ring-offset-width", `${C3.value.value}px`), te2("--tw-ring-offset-shadow", E3)];
        }
        {
          let A3 = W3(C3, r, ["--ring-offset-color", "--color"]);
          if (A3) return [te2("--tw-ring-offset-color", A3)];
        }
      }
    });
  }
...
function ot(r) {
  ...
  return nr.test(t) ? (i) => {
    ...
    w2(r.nodes, (u2) => {
      if (u2.kind !== "declaration" || !u2.value || !u2.value.includes("--value(") && !u2.value.includes("--modifier(")) return;
      let s2 = X2(u2.value);
      C2(s2, (p2) => {
        if (p2.kind !== "function" || p2.value !== "--value" && p2.value !== "--modifier") return;
        let m = u(ue2(p2.nodes), ",");
        for (let [f2, d2] of m.entries()) d2 = d2.replace(/\\\*/g, "*"), d2 = d2.replace(/--(.*?)\s--(.*?)/g, "--$1-*--$2"), d2 = d2.replace(/\s+/g, ""), d2 = d2.replace(/(-\*){2,}/g, "-*"), d2[0] === "-" && d2[1] === "-" && !d2.includes("-*") && (d2 += "-*"), m[f2] = d2;
        p2.nodes = X2(m.join(","));
        for (let f2 of p2.nodes) if (f2.kind === "word" && f2.value[0] === "-" && f2.value[1] === "-") {
          let d2 = f2.value.replace(/-\*.*$/g, "");
          p2.value === "--value" ? e.add(d2) : p2.value === "--modifier" && l3.add(d2);
        }
      }), u2.value = ue2(s2);
    }), i.utilities.functional(t.slice(0, -2), (u2) => {
      let s2 = structuredClone(r), p2 = u2.value, m = u2.modifier;
      if (p2 === null) return;
      let f2 = false, d2 = false, g2 = false, h2 = false, y3 = /* @__PURE__ */ new Map(), b3 = false;
      if (w2([s2], (x, { parent: V3, replaceWith: k3 }) => {
        if ((V3 == null ? void 0 : V3.kind) !== "rule" && (V3 == null ? void 0 : V3.kind) !== "at-rule" || x.kind !== "declaration" || !x.value) return;
        let N3 = X2(x.value);
        (C2(N3, (R3, { replaceWith: D3 }) => {
          if (R3.kind === "function") {
            if (R3.value === "--value") {
              f2 = true;
              let n = nt(p2, R3, i);
              return n ? (d2 = true, n.ratio ? b3 = true : y3.set(x, V3), D3(n.nodes), 1) : (f2 || (f2 = false), k3([]), 2);
            } else if (R3.value === "--modifier") {
              if (m === null) return k3([]), 1;
              g2 = true;
              let n = nt(m, R3, i);
              return n ? (h2 = true, D3(n.nodes), 1) : (g2 || (g2 = false), k3([]), 2);
            }
          }
        }) ?? 0) === 0 && (x.value = ue2(N3));
      }), f2 && !d2 || g2 && !h2 || b3 && h2 || m && !b3 && !h2) return null;
      if (b3) for (let [x, V3] of y3) {
        let k3 = V3.nodes.indexOf(x);
        k3 !== -1 && V3.nodes.splice(k3, 1);
      }
      return s2.nodes;
    }), i.utilities.suggest(t.slice(0, -2), () => [{ values: i.theme.keysInNamespaces(e).map((u2) => u2.replaceAll("_", ".")), modifiers: i.theme.keysInNamespaces(l3).map((u2) => u2.replaceAll("_", ".")) }]);
  } : rr.test(t) ? (i) => {
...
function nt(r, t, i) {
  for (let e of t.nodes) if (r.kind === "named" && e.kind === "word" && e.value[0] === "-" && e.value[1] === "-") {
    ...
    if (l3.endsWith("-*")) {
      l3 = l3.slice(0, -2);
      let u2 = i.theme.resolve(r.value, [l3]);
      if (u2) return { nodes: X2(u2) };
    } else {
      let u2 = l3.split("-*");
      if (u2.length <= 1) continue;
      let s2 = [u2.shift()], p2 = i.theme.resolveWith(r.value, s2, u2);
      if (p2) {
        let [, m = {}] = p2;
        {
          let f2 = m[u2.pop()];
    ...
    if (!l3) continue;
    let u2 = pe(l3, [e.value]);
    if (u2 === null) continue;
    if (u2 === "ratio") {
      let [s2, p2] = u(l3, "/");
      if (!p(s2) || !p(p2)) continue;
    } else {
      if (u2 === "number" && !ue(l3)) continue;
      if (u2 === "percentage" && !p(l3.slice(0, -1))) continue;
    }
    return { nodes: X2(l3), ratio: u2 === "ratio" };
...
var Pe2 = { "--alpha": ir, "--spacing": or, "--theme": lr, theme: st };
function ir(r, t, ...i) {
  let [e, l3] = u(t, "/").map((u2) => u2.trim());
...
var lt = new RegExp(Object.keys(Pe2).map((r) => `${r}\\(`).join("|"));
function ae2(r, t) {
  let i = 0;
  return w2(r, (e) => {
...
function at(r, t) {
  ...
  return C2(i, (e, { replaceWith: l3 }) => {
    if (e.kind === "function" && e.value in Pe2) {
      let u2 = u(ue2(e.nodes).trim(), ",").map((p2) => p2.trim()), s2 = Pe2[e.value](t, ...u2);
      return l3(X2(s2));
    }
  }), ue2(i);
}
function ar(r) {
  ...
  for (let e = 1; e < r.length - 1; e++) {
    let l3 = r[e], u2 = r[e + 1];
    l3 === "\\" && (u2 === i || u2 === "\\") ? (t += u2, e++) : t += l3;
  }
  return t;
}
function xe2(r, t) {
  let i = r.length, e = t.length, l3 = i < e ? i : e;
  for (let u2 = 0; u2 < l3; u2++) {
    let s2 = r.charCodeAt(u2), p2 = t.charCodeAt(u2);
    if (s2 >= 48 && s2 <= 57 && p2 >= 48 && p2 <= 57) {
      let m = u2, f2 = u2 + 1, d2 = u2, g2 = u2 + 1;
      for (s2 = r.charCodeAt(f2); s2 >= 48 && s2 <= 57; ) s2 = r.charCodeAt(++f2);
      for (p2 = t.charCodeAt(g2); p2 >= 48 && p2 <= 57; ) p2 = t.charCodeAt(++g2);
      let h2 = r.slice(m, f2), y3 = t.slice(d2, g2), b3 = Number(h2) - Number(y3);
      if (b3) return b3;
      if (h2 < y3) return -1;
      if (h2 > y3) return 1;
      continue;
...
function ut(r) {
  ...
  for (let e of r.utilities.keys("functional")) {
    ...
    for (let u2 of l3) for (let s2 of u2.values) {
      let p2 = s2 !== null && sr.test(s2), m = s2 === null ? e : `${e}-${s2}`;
      t.push({ name: m, utility: e, fraction: p2, modifiers: u2.modifiers }), u2.supportsNegative && t.push({ name: `-${m}`, utility: `-${e}`, fraction: p2, modifiers: u2.modifiers });
    }
  }
  return t.length === 0 ? [] : (t.sort((e, l3) => xe2(e.name, l3.name)), ur(t));
}
function ur(r) {
  let t = [], i = null, e = /* @__PURE__ */ new Map(), l3 = new N2(() => []);
  for (let s2 of r) {
    let { utility: p2, fraction: m } = s2;
    i || (i = { utility: p2, items: [] }, e.set(p2, i)), p2 !== i.utility && (t.push(i), i = { utility: p2, items: [] }, e.set(p2, i)), m ? l3.get(p2).push(s2) : i.items.push(s2);
  }
  ...
  let u2 = [];
  for (let s2 of t) for (let p2 of s2.items) u2.push([p2.name, { modifiers: p2.modifiers }]);
  return u2;
}
function ft(r) {
  let t = [];
  for (let [e, l3] of r.variants.entries()) {
    let p2 = function({ value: m, modifier: f2 } = {}) {
      let d2 = e;
      m && (d2 += u2 ? `-${m}` : m), f2 && (d2 += `/${f2}`);
      let g2 = r.parseVariant(d2);
      if (!g2) return [];
      let h2 = me(".__placeholder__", []);
      if (se2(h2, g2, r.variants) === null) return [];
      let y3 = [];
      return Z2(h2.nodes, (b3, { path: x }) => {
        if (b3.kind !== "rule" && b3.kind !== "at-rule" || b3.nodes.length > 0) return;
        x.sort((N3, F3) => {
          let R3 = N3.kind === "at-rule", D3 = F3.kind === "at-rule";
          return R3 && !D3 ? -1 : !R3 && D3 ? 1 : 0;
        });
        let V3 = x.flatMap((N3) => N3.kind === "rule" ? N3.selector === "&" ? [] : [N3.selector] : N3.kind === "at-rule" ? [`${N3.name} ${N3.params}`] : []), k3 = "";
        for (let N3 = V3.length - 1; N3 >= 0; N3--) k3 = k3 === "" ? V3[N3] : `${V3[N3]} { ${k3} }`;
        y3.push(k3);
      }), y3;
    };
    var i = p2;
    if (l3.kind === "arbitrary") continue;
    let u2 = e !== "@", s2 = r.variants.getCompletions(e);
    switch (l3.kind) {
      case "static": {
        t.push({ name: e, values: s2, isArbitrary: false, hasDash: u2, selectors: p2 });
        break;
      }
      case "functional": {
        t.push({ name: e, values: s2, isArbitrary: true, hasDash: u2, selectors: p2 });
        break;
      }
      case "compound": {
        t.push({ name: e, values: s2, isArbitrary: true, hasDash: u2, selectors: p2 });
...
function ct(r, t) {
  var _a2;
  let { astNodes: i, nodeSorting: e } = X3(Array.from(t), r), l3 = new Map(t.map((s2) => [s2, null])), u2 = 0n;
  for (let s2 of i) {
    let p2 = (_a2 = e.get(s2)) == null ? void 0 : _a2.candidate;
    p2 && l3.set(p2, l3.get(p2) ?? u2++);
  }
...
var Oe = class {
  ...
  fromAst(t, i) {
    ...
    w2(i, (l3) => {
      ...
      let u2 = structuredClone(i);
      _e(u2, l3.nodes), l3.nodes = u2;
    }, { compounds: ne3(e) });
  }
  functional(t, i, { compounds: e, order: l3 } = {}) {
    this.set(t, { kind: "functional", applyFn: i, compoundsWith: 0, compounds: e ?? 2, order: l3 });
  }
  compound(t, i, e, { compounds: l3, order: u2 } = {}) {
    this.set(t, { kind: "compound", applyFn: e, compoundsWith: i, compounds: l3 ?? 2, order: u2 });
  }
  group(t, i) {
  ...
  compare(t, i) {
    ...
    let e = this.variants.get(t.root).order, l3 = this.variants.get(i.root).order, u2 = e - l3;
    if (u2 !== 0) return u2;
  ...
  set(t, { kind: i, applyFn: e, compounds: l3, compoundsWith: u2, order: s2 }) {
    let p2 = this.variants.get(t);
    p2 ? Object.assign(p2, { kind: i, applyFn: e, compounds: l3 }) : (s2 === void 0 && (this.lastOrder = this.nextOrder(), s2 = this.lastOrder), this.variants.set(t, { kind: i, applyFn: e, order: s2, compoundsWith: u2, compounds: l3 }));
  }
  nextOrder() {
...
function pt(r) {
  let t = new Oe();
  function i(f2, d2, { compounds: g2 } = {}) {
    g2 = g2 ?? ne3(d2), t.static(f2, (h2) => {
      h2.nodes = d2.map((y3) => ee2(y3, h2.nodes));
    }, { compounds: g2 });
  }
  ...
  function e(f2, d2) {
    return d2.map((g2) => {
      g2 = g2.trim();
      let h2 = u(g2, " ");
      return h2[0] === "not" ? h2.slice(1).join(" ") : f2 === "@container" ? h2[0][0] === "(" ? `not ${g2}` : h2[1] === "not" ? `${h2[0]} ${h2.slice(2).join(" ")}` : `${h2[0]} not ${h2.slice(1).join(" ")}` : `not ${g2}`;
    });
  }
  let l3 = ["@media", "@supports", "@container"];
  function u2(f2) {
    for (let d2 of l3) {
      if (d2 !== f2.name) continue;
      let g2 = u(f2.params, ",");
      return g2.length > 1 ? null : (g2 = e(f2.name, g2), V2(f2.name, g2.join(", ")));
    }
    return null;
  }
  function s2(f2) {
    return f2.includes("::") ? null : `&:not(${u(f2, ",").map((g2) => (g2 = g2.replaceAll("&", "*"), g2)).join(", ")})`;
  }
  t.compound("not", 3, (f2, d2) => {
    ...
    if (w2([f2], (h2, { path: y3 }) => {
      ...
      let b3 = [], x = [];
      for (let k3 of y3) k3.kind === "at-rule" ? b3.push(k3) : k3.kind === "rule" && x.push(k3);
      if (b3.length > 1) return 2;
      if (x.length > 1) return 2;
      let V3 = [];
      for (let k3 of x) {
        let N3 = s2(k3.selector);
        if (!N3) return g2 = false, 2;
        V3.push(me(N3, []));
      }
      for (let k3 of b3) {
        let N3 = u2(k3);
      ...
      return Object.assign(f2, me("&", V3)), g2 = true, 1;
    }), f2.kind === "rule" && f2.selector === "&" && f2.nodes.length === 1 && Object.assign(f2, f2.nodes[0]), !g2) return null;
  }), t.suggest("not", () => Array.from(t.keys()).filter((f2) => t.compoundsWith("not", f2))), t.compound("group", 2, (f2, d2) => {
    if (d2.variant.kind === "arbitrary" && d2.variant.relative) return null;
    let g2 = d2.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group\\/${d2.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}group)`, h2 = false;
    if (w2([f2], (y3, { path: b3 }) => {
      if (y3.kind !== "rule") return 0;
      for (let V3 of b3.slice(0, -1)) if (V3.kind === "rule") return h2 = false, 2;
      let x = y3.selector.replaceAll("&", g2);
      u(x, ",").length > 1 && (x = `:is(${x})`), y3.selector = `&:is(${x} *)`, h2 = true;
    }), !h2) return null;
  }), t.suggest("group", () => Array.from(t.keys()).filter((f2) => t.compoundsWith("group", f2))), t.compound("peer", 2, (f2, d2) => {
    if (d2.variant.kind === "arbitrary" && d2.variant.relative) return null;
    let g2 = d2.modifier ? `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer\\/${d2.modifier.value})` : `:where(.${r.prefix ? `${r.prefix}\\:` : ""}peer)`, h2 = false;
    if (w2([f2], (y3, { path: b3 }) => {
      if (y3.kind !== "rule") return 0;
      for (let V3 of b3.slice(0, -1)) if (V3.kind === "rule") return h2 = false, 2;
      let x = y3.selector.replaceAll("&", g2);
  ...
  }), t.suggest("peer", () => Array.from(t.keys()).filter((f2) => t.compoundsWith("peer", f2))), i("first-letter", ["&::first-letter"]), i("first-line", ["&::first-line"]), i("marker", ["& *::marker", "&::marker"]), i("selection", ["& *::selection", "&::selection"]), i("file", ["&::file-selector-button"]), i("placeholder", ["&::placeholder"]), i("backdrop", ["&::backdrop"]), false;
  {
    let f2 = function() {
    ...
    var p2 = f2;
    t.static("before", (d2) => {
      d2.nodes = [me("&::before", [f2(), te2("content", "var(--tw-content)"), ...d2.nodes])];
    }, { compounds: 0 }), t.static("after", (d2) => {
      d2.nodes = [me("&::after", [f2(), te2("content", "var(--tw-content)"), ...d2.nodes])];
    }, { compounds: 0 });
  }
  i("first", ["&:first-child"]), i("last", ["&:last-child"]), i("only", ["&:only-child"]), i("odd", ["&:nth-child(odd)"]), i("even", ["&:nth-child(even)"]), i("first-of-type", ["&:first-of-type"]), i("last-of-type", ["&:last-of-type"]), i("only-of-type", ["&:only-of-type"]), i("visited", ["&:visited"]), i("target", ["&:target"]), i("open", ["&:is([open], :popover-open, :open)"]), i("default", ["&:default"]), i("checked", ["&:checked"]), i("indeterminate", ["&:indeterminate"]), i("placeholder-shown", ["&:placeholder-shown"]), i("autofill", ["&:autofill"]), i("optional", ["&:optional"]), i("required", ["&:required"]), i("valid", ["&:valid"]), i("invalid", ["&:invalid"]), false, i("in-range", ["&:in-range"]), i("out-of-range", ["&:out-of-range"]), i("read-only", ["&:read-only"]), i("empty", ["&:empty"]), i("focus-within", ["&:focus-within"]), t.static("hover", (f2) => {
    f2.nodes = [me("&:hover", [V2("@media", "(hover: hover)", f2.nodes)])];
  }), i("focus", ["&:focus"]), i("focus-visible", ["&:focus-visible"]), i("active", ["&:active"]), i("enabled", ["&:enabled"]), i("disabled", ["&:disabled"]), i("inert", ["&:is([inert], [inert] *)"]), t.compound("in", 2, (f2, d2) => {
    if (d2.modifier) return null;
    let g2 = false;
    if (w2([f2], (h2, { path: y3 }) => {
      if (h2.kind !== "rule") return 0;
      for (let b3 of y3.slice(0, -1)) if (b3.kind === "rule") return g2 = false, 2;
      h2.selector = `:where(${h2.selector.replaceAll("&", "*")}) &`, g2 = true;
    }), !g2) return null;
  }), t.suggest("in", () => Array.from(t.keys()).filter((f2) => t.compoundsWith("in", f2))), t.compound("has", 2, (f2, d2) => {
    if (d2.modifier) return null;
    let g2 = false;
    if (w2([f2], (h2, { path: y3 }) => {
      if (h2.kind !== "rule") return 0;
  ...
  }), t.suggest("has", () => Array.from(t.keys()).filter((f2) => t.compoundsWith("has", f2))), t.functional("aria", (f2, d2) => {
    if (!d2.value || d2.modifier) return null;
    d2.value.kind === "arbitrary" ? f2.nodes = [me(`&[aria-${dt(d2.value.value)}]`, f2.nodes)] : f2.nodes = [me(`&[aria-${d2.value.value}="true"]`, f2.nodes)];
  }), t.suggest("aria", () => ["busy", "checked", "disabled", "expanded", "hidden", "pressed", "readonly", "required", "selected"]), t.functional("data", (f2, d2) => {
    if (!d2.value || d2.modifier) return null;
    f2.nodes = [me(`&[data-${dt(d2.value.value)}]`, f2.nodes)];
  }), t.functional("nth", (f2, d2) => {
    if (!d2.value || d2.modifier || d2.value.kind === "named" && !p(d2.value.value)) return null;
    f2.nodes = [me(`&:nth-child(${d2.value.value})`, f2.nodes)];
  }), t.functional("nth-last", (f2, d2) => {
    if (!d2.value || d2.modifier || d2.value.kind === "named" && !p(d2.value.value)) return null;
    f2.nodes = [me(`&:nth-last-child(${d2.value.value})`, f2.nodes)];
  }), t.functional("nth-of-type", (f2, d2) => {
    if (!d2.value || d2.modifier || d2.value.kind === "named" && !p(d2.value.value)) return null;
    f2.nodes = [me(`&:nth-of-type(${d2.value.value})`, f2.nodes)];
  }), t.functional("nth-last-of-type", (f2, d2) => {
    if (!d2.value || d2.modifier || d2.value.kind === "named" && !p(d2.value.value)) return null;
    f2.nodes = [me(`&:nth-last-of-type(${d2.value.value})`, f2.nodes)];
  }), t.functional("supports", (f2, d2) => {
    if (!d2.value || d2.modifier) return null;
    let g2 = d2.value.value;
    if (g2 === null) return null;
    if (/^[\w-]*\s*\(/.test(g2)) {
      let h2 = g2.replace(/\b(and|or|not)\b/g, " $1 ");
      f2.nodes = [V2("@supports", h2, f2.nodes)];
      return;
    }
    g2.includes(":") || (g2 = `${g2}: var(--tw)`), (g2[0] !== "(" || g2[g2.length - 1] !== ")") && (g2 = `(${g2})`), f2.nodes = [V2("@supports", g2, f2.nodes)];
  ...
  {
    let f2 = function(d2, g2, h2, y3) {
      if (d2 === g2) return 0;
      let b3 = y3.get(d2);
      if (b3 === null) return h2 === "asc" ? -1 : 1;
      let x = y3.get(g2);
      return x === null ? h2 === "asc" ? 1 : -1 : te3(b3, x, h2);
    };
    var m = f2;
    {
      let d2 = r.namespace("--breakpoint"), g2 = new N2((h2) => {
        switch (h2.kind) {
          case "static":
          ...
          case "functional": {
            ...
            let y3 = null;
            return h2.value.kind === "arbitrary" ? y3 = h2.value.value : h2.value.kind === "named" && (y3 = r.resolveValue(h2.value.value, ["--breakpoint"])), !y3 || y3.includes("var(") ? null : y3;
          }
          case "arbitrary":
          case "compound":
            return null;
      ...
      t.group(() => {
        t.functional("max", (h2, y3) => {
          if (y3.modifier) return null;
          let b3 = g2.get(y3);
          if (b3 === null) return null;
          h2.nodes = [V2("@media", `(width < ${b3})`, h2.nodes)];
        }, { compounds: 1 });
      }, (h2, y3) => f2(h2, y3, "desc", g2)), t.suggest("max", () => Array.from(d2.keys()).filter((h2) => h2 !== null)), t.group(() => {
        for (let [h2, y3] of r.namespace("--breakpoint")) h2 !== null && t.static(h2, (b3) => {
          b3.nodes = [V2("@media", `(width >= ${y3})`, b3.nodes)];
        }, { compounds: 1 });
        t.functional("min", (h2, y3) => {
          if (y3.modifier) return null;
          let b3 = g2.get(y3);
          if (b3 === null) return null;
          h2.nodes = [V2("@media", `(width >= ${b3})`, h2.nodes)];
        }, { compounds: 1 });
      }, (h2, y3) => f2(h2, y3, "asc", g2)), t.suggest("min", () => Array.from(d2.keys()).filter((h2) => h2 !== null));
    }
    {
      let d2 = r.namespace("--container"), g2 = new N2((h2) => {
        switch (h2.kind) {
          case "functional": {
            if (h2.value === null) return null;
            let y3 = null;
            return h2.value.kind === "arbitrary" ? y3 = h2.value.value : h2.value.kind === "named" && (y3 = r.resolveValue(h2.value.value, ["--container"])), !y3 || y3.includes("var(") ? null : y3;
          }
          case "static":
          case "arbitrary":
          case "compound":
      ...
      t.group(() => {
        t.functional("@max", (h2, y3) => {
          let b3 = g2.get(y3);
          if (b3 === null) return null;
          h2.nodes = [V2("@container", y3.modifier ? `${y3.modifier.value} (width < ${b3})` : `(width < ${b3})`, h2.nodes)];
        }, { compounds: 1 });
      }, (h2, y3) => f2(h2, y3, "desc", g2)), t.suggest("@max", () => Array.from(d2.keys()).filter((h2) => h2 !== null)), t.group(() => {
        t.functional("@", (h2, y3) => {
          let b3 = g2.get(y3);
          if (b3 === null) return null;
          h2.nodes = [V2("@container", y3.modifier ? `${y3.modifier.value} (width >= ${b3})` : `(width >= ${b3})`, h2.nodes)];
        }, { compounds: 1 }), t.functional("@min", (h2, y3) => {
          let b3 = g2.get(y3);
          if (b3 === null) return null;
          h2.nodes = [V2("@container", y3.modifier ? `${y3.modifier.value} (width >= ${b3})` : `(width >= ${b3})`, h2.nodes)];
        }, { compounds: 1 });
      }, (h2, y3) => f2(h2, y3, "asc", g2)), t.suggest("@min", () => Array.from(d2.keys()).filter((h2) => h2 !== null)), t.suggest("@", () => Array.from(d2.keys()).filter((h2) => h2 !== null));
    }
  }
...
function gt(r) {
  let t = it(r), i = pt(r), e = new N2((m) => et(m, p2)), l3 = new N2((m) => Array.from(Qe(m, p2))), u2 = new N2((m) => {
    let f2 = mt(m, p2);
    try {
      ae2(f2.map(({ node: d2 }) => d2), p2);
    } catch {
      return [];
    }
    return f2;
  }), s2 = new N2((m) => {
    for (let f2 of J2(m)) r.markUsedVariable(f2);
  }), p2 = { theme: r, utilities: t, variants: i, invalidCandidates: /* @__PURE__ */ new Set(), important: false, candidatesToCss(m) {
    let f2 = [];
    for (let d2 of m) {
      let g2 = false, { astNodes: h2 } = X3([d2], this, { onInvalidCandidate() {
        g2 = true;
      } });
      h2 = Pe(h2, p2), h2.length === 0 || g2 ? f2.push(null) : f2.push(Fe(h2));
    }
    return f2;
  }, getClassOrder(m) {
    return ct(this, m);
    ...
    m.sort((h2, y3) => this.variants.compare(h2, y3));
    let f2 = /* @__PURE__ */ new Map(), d2, g2 = 0;
    for (let h2 of m) h2 !== null && (d2 !== void 0 && this.variants.compare(d2, h2) !== 0 && g2++, f2.set(h2, g2), d2 = h2);
    return f2;
  }, resolveThemeValue(m) {
    let f2 = m.lastIndexOf("/"), d2 = null;
    f2 !== -1 && (d2 = m.slice(f2 + 1).trim(), m = m.slice(0, f2).trim());
    let g2 = r.get([m]) ?? void 0;
    return d2 && g2 ? G3(g2, d2) : g2;
...
function X3(r, t, { onInvalidCandidate: i } = {}) {
  let e = /* @__PURE__ */ new Map(), l3 = [], u2 = /* @__PURE__ */ new Map();
  for (let p2 of r) {
  ...
  for (let [p2, m] of u2) {
    let f2 = false;
    for (let d2 of m) {
      let g2 = t.compileAstNodes(d2);
      if (g2.length !== 0) {
        f2 = true;
        for (let { node: h2, propertySort: y3 } of g2) {
          let b3 = 0n;
          for (let x of d2.variants) b3 |= 1n << BigInt(s2.get(x));
          e.set(h2, { properties: y3, variants: b3, candidate: p2 }), l3.push(h2);
        }
      }
    }
    f2 || (i == null ? void 0 : i(p2));
  }
  return l3.sort((p2, m) => {
    let f2 = e.get(p2), d2 = e.get(m);
    if (f2.variants - d2.variants !== 0n) return Number(f2.variants - d2.variants);
    let g2 = 0;
    for (; g2 < f2.properties.order.length && g2 < d2.properties.order.length && f2.properties.order[g2] === d2.properties.order[g2]; ) g2 += 1;
    return (f2.properties.order[g2] ?? 1 / 0) - (d2.properties.order[g2] ?? 1 / 0) || d2.properties.count - f2.properties.count || xe2(f2.candidate, d2.candidate);
...
function mt(r, t) {
  ...
  for (let u2 of i) {
    let s2 = hr(u2);
    (r.important || t.important) && vt(u2);
    let p2 = { kind: "rule", selector: l3, nodes: u2 };
...
function mr(r, t) {
  ...
  let i = t.utilities.get(r.root) ?? [], e = [], l3 = i.filter((s2) => !ht(s2));
  for (let s2 of l3) {
...
function vt(r) {
  for (let t of r) t.kind !== "at-root" && (t.kind === "declaration" ? t.important = true : (t.kind === "rule" || t.kind === "at-rule") && vt(t.nodes));
}
function hr(r) {
  let t = /* @__PURE__ */ new Set(), i = 0, e = r.slice(), l3 = false;
  for (; e.length > 0; ) {
    let u2 = e.shift();
    if (u2.kind === "declaration") {
      if (u2.value === void 0 || (i++, l3)) continue;
      if (u2.property === "--tw-sort") {
        let p2 = De2.indexOf(u2.value ?? "");
        if (p2 !== -1) {
          t.add(p2), l3 = true;
          continue;
        }
      }
      let s2 = De2.indexOf(u2.property);
      s2 !== -1 && t.add(s2);
    } else if (u2.kind === "rule" || u2.kind === "at-rule") for (let s2 of u2.nodes) e.push(s2);
  }
  return { order: Array.from(t).sort((u2, s2) => u2 - s2), count: i };
}
function ge3(r, t) {
  let i = 0, e = ee2("&", r), l3 = /* @__PURE__ */ new Set(), u2 = new N2(() => /* @__PURE__ */ new Set()), s2 = new N2(() => /* @__PURE__ */ new Set());
  w2([e], (g2, { parent: h2 }) => {
    if (g2.kind === "at-rule") {
      if (g2.name === "@keyframes") return w2(g2.nodes, (y3) => {
        if (y3.kind === "at-rule" && y3.name === "@apply") throw new Error("You cannot use `@apply` inside `@keyframes`.");
      }), 1;
      if (g2.name === "@utility") {
        let y3 = g2.params.replace(/-\*$/, "");
        s2.get(y3).add(g2), w2(g2.nodes, (b3) => {
          if (!(b3.kind !== "at-rule" || b3.name !== "@apply")) {
            l3.add(g2);
            for (let x of yt(b3, t)) u2.get(g2).add(x);
          }
        });
        return;
      }
      if (g2.name === "@apply") {
        if (h2 === null) return;
        i |= 1, l3.add(h2);
        for (let y3 of yt(g2, t)) u2.get(h2).add(y3);
      }
    }
  });
  let p2 = /* @__PURE__ */ new Set(), m = [], f2 = /* @__PURE__ */ new Set();
  function d2(g2, h2 = []) {
    if (!p2.has(g2)) {
      if (f2.has(g2)) {
        let y3 = h2[(h2.indexOf(g2) + 1) % h2.length];
        throw g2.kind === "at-rule" && g2.name === "@utility" && y3.kind === "at-rule" && y3.name === "@utility" && w2(g2.nodes, (b3) => {
          if (b3.kind !== "at-rule" || b3.name !== "@apply") return;
          let x = b3.params.split(/\s+/g);
          for (let V3 of x) for (let k3 of t.parseCandidate(V3)) switch (k3.kind) {
            case "arbitrary":
              break;
            case "static":
            case "functional":
              if (y3.params.replace(/-\*$/, "") === k3.root) throw new Error(`You cannot \`@apply\` the \`${V3}\` utility here because it creates a circular dependency.`);
              break;
            default:
          }
...
${Fe([y3])}`);
      ...
      f2.add(g2);
      for (let y3 of u2.get(g2)) for (let b3 of s2.get(y3)) h2.push(g2), d2(b3, h2), h2.pop();
      p2.add(g2), f2.delete(g2), m.push(g2);
    }
  }
  for (let g2 of l3) d2(g2);
  for (let g2 of m) if ("nodes" in g2) for (let h2 = 0; h2 < g2.nodes.length; h2++) {
    let y3 = g2.nodes[h2];
    if (y3.kind !== "at-rule" || y3.name !== "@apply") continue;
    let b3 = y3.params.split(/\s+/g);
    {
      let x = X3(b3, t, { onInvalidCandidate: (k3) => {
        throw new Error(`Cannot apply unknown utility class: ${k3}`);
      } }).astNodes, V3 = [];
      for (let k3 of x) if (k3.kind === "rule") for (let N3 of k3.nodes) V3.push(N3);
      else V3.push(k3);
      g2.nodes.splice(h2, 1, ...V3);
    }
  }
  return i;
}
...
function xt(r, t = [], i) {
  for (let e of Reflect.ownKeys(r)) {
    let l3 = r[e];
    if (l3 == null) continue;
    let u2 = [...t, e], s2 = i(l3, u2) ?? 0;
    if (s2 !== 1) {
      if (s2 === 2) return 2;
      if (!(!Array.isArray(l3) && typeof l3 != "object") && xt(l3, u2, i) === 2) return 2;
    }
  }
}
function Ve(r) {
  ...
  for (let i of u(r, ".")) {
    ...
    let e = 0;
    for (; ; ) {
      let l3 = i.indexOf("[", e), u2 = i.indexOf("]", l3);
      if (l3 === -1 || u2 === -1) break;
      l3 > e && t.push(i.slice(e, l3)), t.push(i.slice(l3 + 1, u2)), e = u2 + 1;
    }
...
function me2(r, t, i, e = []) {
  for (let l3 of t) if (l3 != null) for (let u2 of Reflect.ownKeys(l3)) {
    e.push(u2);
    let s2 = i(r[u2], l3[u2], e);
    s2 !== void 0 ? r[u2] = s2 : !fe2(r[u2]) || !fe2(l3[u2]) ? r[u2] = l3[u2] : r[u2] = me2({}, [r[u2], l3[u2]], i, e), e.pop();
  }
  return r;
}
function $e(r, t, i) {
  return function(l3, u2) {
    let s2 = l3.lastIndexOf("/"), p2 = null;
    s2 !== -1 && (p2 = l3.slice(s2 + 1).trim(), l3 = l3.slice(0, s2).trim());
    let m = (() => {
      var _a2;
      let f2 = Ve(l3), [d2, g2] = Ar(r.theme, f2), h2 = i(At(t() ?? {}, f2) ?? null);
      if (typeof h2 == "string" && (h2 = h2.replace("<alpha-value>", "1")), typeof d2 != "object") return typeof g2 != "object" && g2 & 4 ? h2 ?? d2 : d2;
      if (h2 !== null && typeof h2 == "object" && !Array.isArray(h2)) {
        let y3 = me2({}, [h2], (b3, x) => x);
        if (d2 === null && Object.hasOwn(h2, "__CSS_VALUES__")) {
          let b3 = {};
          for (let x in h2.__CSS_VALUES__) b3[x] = h2[x], delete y3[x];
          d2 = b3;
        }
        for (let b3 in d2) b3 !== "__CSS_VALUES__" && (((_a2 = h2 == null ? void 0 : h2.__CSS_VALUES__) == null ? void 0 : _a2[b3]) & 4 && At(y3, b3.split("-")) !== void 0 || (y3[$2(b3)] = d2[b3]));
        return y3;
      }
      if (Array.isArray(d2) && Array.isArray(g2) && Array.isArray(h2)) {
        let y3 = d2[0], b3 = d2[1];
        g2[0] & 4 && (y3 = h2[0] ?? y3);
        for (let x of Object.keys(b3)) g2[1][x] & 4 && (b3[x] = h2[1][x] ?? b3[x]);
        return [y3, b3];
      }
      return d2 ?? h2;
    })();
    return p2 && typeof m == "string" && (m = G3(m, p2)), m ?? u2;
  };
}
function Ar(r, t) {
  if (t.length === 1 && t[0].startsWith("--")) return [r.get([t[0]]), r.getOptions(t[0])];
  let i = Ce2(t), e = /* @__PURE__ */ new Map(), l3 = new N2(() => /* @__PURE__ */ new Map()), u2 = r.namespace(`--${i}`);
  if (u2.size === 0) return [null, 0];
  let s2 = /* @__PURE__ */ new Map();
  for (let [d2, g2] of u2) {
    if (!d2 || !d2.includes("--")) {
      e.set(d2, g2), s2.set(d2, r.getOptions(d2 ? `--${i}-${d2}` : `--${i}`));
      continue;
    }
    let h2 = d2.indexOf("--"), y3 = d2.slice(0, h2), b3 = d2.slice(h2 + 2);
    b3 = b3.replace(/-([a-z])/g, (x, V3) => V3.toUpperCase()), l3.get(y3 === "" ? null : y3).set(b3, [g2, r.getOptions(`--${i}${d2}`)]);
  }
  ...
  for (let [d2, g2] of l3) {
    ...
    let y3 = {}, b3 = {};
    for (let [x, [V3, k3]] of g2) y3[x] = V3, b3[x] = k3;
    e.set(d2, [h2, y3]), s2.set(d2, [p2, b3]);
  }
  let m = {}, f2 = {};
  for (let [d2, g2] of e) Ct(m, [d2 ?? "DEFAULT"], g2);
  for (let [d2, g2] of s2) Ct(f2, [d2 ?? "DEFAULT"], g2);
  return t[t.length - 1] === "DEFAULT" ? [(m == null ? void 0 : m.DEFAULT) ?? null, f2.DEFAULT ?? 0] : "DEFAULT" in m && Object.keys(m).length === 1 ? [m.DEFAULT, f2.DEFAULT ?? 0] : (m.__CSS_VALUES__ = f2, [m, f2]);
}
function At(r, t) {
...
function ve2(r, t, i = null) {
  for (let e = 0; e < r.length; e++) {
    let l3 = r[e], u2 = false, s2 = 0, p2 = t(l3, { parent: i, replaceWith(m) {
      u2 = true, Array.isArray(m) ? m.length === 0 ? (r.splice(e, 1), s2 = 0) : m.length === 1 ? (r[e] = m[0], s2 = 1) : (r.splice(e, 1, ...m), s2 = m.length) : (r[e] = m, s2 = 1);
    } }) ?? 0;
    if (u2) {
      p2 === 0 ? e-- : e += s2 - 1;
      continue;
  ...
  for (let s2 = 0; s2 < r.length; s2++) {
    ...
    switch (p2) {
      ...
      case Ot: {
        if (l3.length > 0) {
          let h2 = he2(l3);
          e ? e.nodes.push(h2) : t.push(h2), l3 = "";
        }
        let m = s2, f2 = s2 + 1;
        for (; f2 < r.length && (u2 = r.charCodeAt(f2), !(u2 !== Tt && u2 !== Nt && u2 !== St && u2 !== jt && u2 !== Kt && u2 !== Pt && u2 !== Ot)); f2++) ;
        s2 = f2 - 1;
        let d2 = r.slice(m, f2), g2 = d2.trim() === "," ? $r(d2) : Cr(d2);
      ...
      case Rt: {
        ...
        if (l3 = "", m.value !== ":not" && m.value !== ":where" && m.value !== ":has" && m.value !== ":is") {
          let f2 = s2 + 1, d2 = 0;
          for (let h2 = s2 + 1; h2 < r.length; h2++) {
            if (u2 = r.charCodeAt(h2), u2 === Rt) {
              d2++;
              continue;
            }
            if (u2 === $t) {
          ...
          let g2 = s2;
          m.nodes.push(Tr(r.slice(f2, g2))), l3 = "", s2 = g2, e ? e.nodes.push(m) : t.push(m);
          break;
        }
      ...
      case Er: {
        let m = s2;
        for (let f2 = s2 + 1; f2 < r.length; f2++) if (u2 = r.charCodeAt(f2), u2 === Vt) f2 += 1;
        else if (u2 === p2) {
          s2 = f2;
          break;
        }
...
function Ue({ designSystem: r, ast: t, resolvedConfig: i, featuresRef: e, referenceMode: l3 }) {
  let u2 = { addBase(s2) {
    if (l3) return;
    let p2 = Z3(s2);
    ...
    function f2(g2, h2, y3) {
      let b3 = p2(g2, { modifier: (h2 == null ? void 0 : h2.value) ?? null });
      return Dt(b3, y3);
    }
    let d2 = Object.keys((m == null ? void 0 : m.values) ?? {});
    r.variants.group(() => {
      r.variants.functional(s2, (g2, h2) => {
        if (!h2.value) {
          if ((m == null ? void 0 : m.values) && "DEFAULT" in m.values) {
            g2.nodes = f2(m.values.DEFAULT, h2.modifier, g2.nodes);
            return;
          }
          return null;
        }
        if (h2.value.kind === "arbitrary") g2.nodes = f2(h2.value.value, h2.modifier, g2.nodes);
        else if (h2.value.kind === "named" && (m == null ? void 0 : m.values)) {
          let y3 = m.values[h2.value.value];
          if (typeof y3 != "string") return;
          g2.nodes = f2(y3, h2.modifier, g2.nodes);
        }
      });
    }, (g2, h2) => {
      var _a2, _b, _c, _d;
      if (g2.kind !== "functional" || h2.kind !== "functional") return 0;
      let y3 = g2.value ? g2.value.value : "DEFAULT", b3 = h2.value ? h2.value.value : "DEFAULT", x = ((_a2 = m == null ? void 0 : m.values) == null ? void 0 : _a2[y3]) ?? y3, V3 = ((_b = m == null ? void 0 : m.values) == null ? void 0 : _b[b3]) ?? b3;
      if (m && typeof m.sort == "function") return m.sort({ value: x, modifier: ((_c = g2.modifier) == null ? void 0 : _c.value) ?? null }, { value: V3, modifier: ((_d = h2.modifier) == null ? void 0 : _d.value) ?? null });
      let k3 = d2.indexOf(y3), N3 = d2.indexOf(b3);
      return k3 = k3 === -1 ? d2.length : k3, N3 = N3 === -1 ? d2.length : N3, k3 !== N3 ? k3 - N3 : x < V3 ? -1 : 1;
    });
  }, addUtilities(s2) {
    s2 = Array.isArray(s2) ? s2 : [s2];
    let p2 = s2.flatMap((f2) => Object.entries(f2));
    p2 = p2.flatMap(([f2, d2]) => u(f2, ",").map((g2) => [g2.trim(), d2]));
    let m = new N2(() => []);
    for (let [f2, d2] of p2) {
      if (f2.startsWith("@keyframes ")) {
        l3 || t.push(ee2(f2, Z3(d2)));
        continue;
      }
      let g2 = Te(f2), h2 = false;
      if (ve2(g2, (y3) => {
        if (y3.kind === "selector" && y3.value[0] === "." && _t.test(y3.value.slice(1))) {
          let b3 = y3.value;
          y3.value = "&";
          let x = ye3(g2), V3 = b3.slice(1), k3 = x === "&" ? Z3(d2) : [ee2(x, Z3(d2))];
          m.get(V3).push(...k3), h2 = true, y3.value = b3;
          return;
        }
    ...
    for (let [f2, d2] of m) r.theme.prefix && w2(d2, (g2) => {
      if (g2.kind === "rule") {
        let h2 = Te(g2.selector);
        ve2(h2, (y3) => {
          y3.kind === "selector" && y3.value[0] === "." && (y3.value = `.${r.theme.prefix}\\:${y3.value.slice(1)}`);
        }), g2.selector = ye3(h2);
      }
    }), r.utilities.static(f2, (g2) => {
      let h2 = structuredClone(d2);
      return Ft(h2, f2, g2.raw), e.current |= ge3(h2, r), h2;
    });
  }, matchUtilities(s2, p2) {
    let m = (p2 == null ? void 0 : p2.type) ? Array.isArray(p2 == null ? void 0 : p2.type) ? p2.type : [p2.type] : ["any"];
    for (let [d2, g2] of Object.entries(s2)) {
      let h2 = function({ negative: y3 }) {
        return (b3) => {
          var _a2, _b;
          if (((_a2 = b3.value) == null ? void 0 : _a2.kind) === "arbitrary" && m.length > 0 && !m.includes("any") && (b3.value.dataType && !m.includes(b3.value.dataType) || !b3.value.dataType && !pe(b3.value.value, m))) return;
          let x = m.includes("color"), V3 = null, k3 = false;
          {
            let R3 = (p2 == null ? void 0 : p2.values) ?? {};
            x && (R3 = Object.assign({ inherit: "inherit", transparent: "transparent", current: "currentColor" }, R3)), b3.value ? b3.value.kind === "arbitrary" ? V3 = b3.value.value : b3.value.fraction && R3[b3.value.fraction] ? (V3 = R3[b3.value.fraction], k3 = true) : R3[b3.value.value] ? V3 = R3[b3.value.value] : R3.__BARE_VALUE__ && (V3 = R3.__BARE_VALUE__(b3.value) ?? null, k3 = (b3.value.fraction !== null && (V3 == null ? void 0 : V3.includes("/"))) ?? false) : V3 = R3.DEFAULT ?? null;
          }
          if (V3 === null) return;
          let N3;
          {
            let R3 = (p2 == null ? void 0 : p2.modifiers) ?? null;
            b3.modifier ? R3 === "any" || b3.modifier.kind === "arbitrary" ? N3 = b3.modifier.value : (R3 == null ? void 0 : R3[b3.modifier.value]) ? N3 = R3[b3.modifier.value] : x && !Number.isNaN(Number(b3.modifier.value)) ? N3 = `${b3.modifier.value}%` : N3 = null : N3 = null;
          }
          if (b3.modifier && N3 === null && !k3) return ((_b = b3.value) == null ? void 0 : _b.kind) === "arbitrary" ? null : void 0;
          x && N3 !== null && (V3 = G3(V3, N3)), y3 && (V3 = `calc(${V3} * -1)`);
          let F3 = Z3(g2(V3, { modifier: N3 }));
          return Ft(F3, d2, b3.raw), e.current |= ge3(F3, r), F3;
        };
      };
      var f2 = h2;
      if (!_t.test(d2)) throw new Error(`\`matchUtilities({ '${d2}' : … })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);
      (p2 == null ? void 0 : p2.supportsNegativeValues) && r.utilities.functional(`-${d2}`, h2({ negative: true }), { types: m }), r.utilities.functional(d2, h2({ negative: false }), { types: m }), r.utilities.suggest(d2, () => {
        let y3 = (p2 == null ? void 0 : p2.values) ?? {}, b3 = new Set(Object.keys(y3));
        b3.delete("__BARE_VALUE__"), b3.has("DEFAULT") && (b3.delete("DEFAULT"), b3.add(null));
        let x = (p2 == null ? void 0 : p2.modifiers) ?? {}, V3 = x === "any" ? [] : Object.keys(x);
        return [{ supportsNegative: (p2 == null ? void 0 : p2.supportsNegativeValues) ?? false, values: Array.from(b3), modifiers: V3 }];
      });
    }
  }, addComponents(s2, p2) {
    ...
    for (let d2 = 0; d2 < f2.length; ++d2) {
      let g2 = f2[d2];
      if (m[g2] === void 0) return p2;
      m = m[g2];
    }
    return m ?? p2;
  } };
  return u2.addComponents = u2.addComponents.bind(u2), u2.matchComponents = u2.matchComponents.bind(u2), u2;
}
function Z3(r) {
  let t = [];
  ...
  } else if (Array.isArray(l3)) for (let u2 of l3) typeof u2 == "string" ? t.push(te2(e, u2)) : t.push(ee2(e, Z3(u2)));
...
function Dt(r, t) {
  return (typeof r == "string" ? [r] : r).flatMap((e) => {
    if (e.trim().endsWith("}")) {
      let l3 = e.replace("}", "{@slot}}"), u2 = Be(l3);
      return _e(u2, t), u2;
    } else return ee2(e, t);
  });
}
function Ft(r, t, i) {
  w2(r, (e) => {
    if (e.kind === "rule") {
      ...
      ve2(l3, (u2) => {
        u2.kind === "selector" && u2.value === `.${t}` && (u2.value = `.${W2(i)}`);
      }), e.selector = ye3(l3);
    }
  });
}
...
var _r = { blocklist: [], future: {}, prefix: "", important: false, darkMode: null, theme: {}, plugins: [], content: { files: [] } };
function ze(r, t) {
  let i = { design: r, configs: [], plugins: [], content: { files: [] }, theme: {}, extend: {}, result: structuredClone(_r) };
  for (let l3 of t) Ie(i, l3);
...
function Ie(r, { config: t, base: i, path: e, reference: l3 }) {
  let u2 = [];
  for (let m of t.plugins ?? []) "__isOptionsFunction" in m ? u2.push({ ...m(), reference: l3 }) : "handler" in m ? u2.push({ ...m, reference: l3 }) : u2.push({ handler: m, reference: l3 });
  ...
  for (let m of t.presets ?? []) Ie(r, { path: e, base: i, config: m, reference: l3 });
  for (let m of u2) r.plugins.push(m), m.config && Ie(r, { path: e, base: i, config: m.config, reference: !!m.reference });
  let s2 = t.content ?? [], p2 = Array.isArray(s2) ? s2 : s2.files;
  for (let m of p2) r.content.files.push(typeof m == "object" ? m : { base: i, pattern: m });
  r.configs.push(t);
}
function Fr(r) {
  var _a2;
  ...
  function l3(u2) {
    return typeof u2 == "function" ? u2(e) ?? null : u2 ?? null;
  }
  for (let u2 of r.configs) {
    let s2 = u2.theme ?? {}, p2 = s2.extend ?? {};
  ...
  for (let u2 in r.extend) {
    let s2 = [r.theme[u2], ...r.extend[u2]];
    r.theme[u2] = () => {
      let p2 = s2.map(l3);
      return me2({}, p2, Dr);
    };
  }
  for (let u2 in r.theme) r.theme[u2] = l3(r.theme[u2]);
  if (r.theme.screens && typeof r.theme.screens == "object") for (let u2 of Object.keys(r.theme.screens)) {
    let s2 = r.theme.screens[u2];
    s2 && typeof s2 == "object" && ("raw" in s2 || "max" in s2 || "min" in s2 && (r.theme.screens[u2] = s2.min));
  }
  return t;
}
function zt(r, t) {
...
function Ur({ center: r, padding: t, screens: i }, e) {
  ...
  if (r && l3.push(te2("margin-inline", "auto")), (typeof t == "string" || typeof t == "object" && t !== null && "DEFAULT" in t) && l3.push(te2("padding-inline", typeof t == "string" ? t : t.DEFAULT)), typeof i == "object" && i !== null) {
    ...
    for (let [p2, m] of Object.entries(i)) {
      if (typeof m == "object") if ("min" in m) m = m.min;
      else continue;
      u2.set(p2, V2("@media", `(width >= ${m})`, [te2("max-width", m)]));
    }
  }
  if (typeof t == "object" && t !== null) {
    ...
    for (let [p2, , m] of s2) if (u2 && u2.has(p2)) u2.get(p2).nodes.push(te2("padding-inline", m));
    else {
      if (u2) continue;
      l3.push(V2("@media", `(width >= theme(--breakpoint-${p2}))`, [te2("padding-inline", m)]));
    }
  }
  if (u2) for (let [, s2] of u2) l3.push(s2);
  return l3;
}
function Mt({ addVariant: r, config: t }) {
  ...
  if (e === "variant") {
    let u2;
    if (Array.isArray(l3) || typeof l3 == "function" ? u2 = l3 : typeof l3 == "string" && (u2 = [l3]), Array.isArray(u2)) for (let s2 of u2) s2 === ".dark" ? (e = false, console.warn('When using `variant` for `darkMode`, you must provide a selector.\nExample: `darkMode: ["variant", ".your-selector &"]`')) : s2.includes("&") || (e = false, console.warn('When using `variant` for `darkMode`, your selector must contain `&`.\nExample `darkMode: ["variant", ".your-selector &"]`'));
    l3 = u2;
  }
...
function Bt(r, t) {
  ...
  for (let [s2, p2] of Object.entries(i)) {
    let h2 = function(y3) {
      t.variants.static(s2, (b3) => {
        b3.nodes = [V2("@media", g2, b3.nodes)];
      }, { order: y3 });
    };
    var u2 = h2;
    let m = t.variants.get(s2), f2 = t.theme.resolveValue(s2, ["--breakpoint"]);
    if (m && f2 && !t.theme.hasDefault(`--breakpoint-${s2}`)) continue;
    let d2 = true;
...
function Wt(r, t) {
  ...
  if (Object.keys(i).length > 0) {
    let u2 = t.variants.get("aria"), s2 = u2 == null ? void 0 : u2.applyFn, p2 = u2 == null ? void 0 : u2.compounds;
    t.variants.functional("aria", (m, f2) => {
      let d2 = f2.value;
      return d2 && d2.kind === "named" && d2.value in i ? s2 == null ? void 0 : s2(m, { ...f2, value: { kind: "arbitrary", value: i[d2.value] } }) : s2 == null ? void 0 : s2(m, f2);
    }, { compounds: p2 });
  }
  if (Object.keys(e).length > 0) {
    let u2 = t.variants.get("supports"), s2 = u2 == null ? void 0 : u2.applyFn, p2 = u2 == null ? void 0 : u2.compounds;
    t.variants.functional("supports", (m, f2) => {
      let d2 = f2.value;
      return d2 && d2.kind === "named" && d2.value in e ? s2 == null ? void 0 : s2(m, { ...f2, value: { kind: "arbitrary", value: e[d2.value] } }) : s2 == null ? void 0 : s2(m, f2);
    }, { compounds: p2 });
  }
  if (Object.keys(l3).length > 0) {
    let u2 = t.variants.get("data"), s2 = u2 == null ? void 0 : u2.applyFn, p2 = u2 == null ? void 0 : u2.compounds;
    t.variants.functional("data", (m, f2) => {
      let d2 = f2.value;
      return d2 && d2.kind === "named" && d2.value in l3 ? s2 == null ? void 0 : s2(m, { ...f2, value: { kind: "arbitrary", value: l3[d2.value] } }) : s2 == null ? void 0 : s2(m, f2);
    }, { compounds: p2 });
  }
}
var zr = /^[a-z]+$/;
async function Jt({ designSystem: r, base: t, ast: i, loadModule: e, globs: l3 }) {
  let u2 = 0, s2 = [], p2 = [];
  w2(i, (g2, { parent: h2, replaceWith: y3, context: b3 }) => {
    if (g2.kind === "at-rule") {
      if (g2.name === "@plugin") {
        if (h2 !== null) throw new Error("`@plugin` cannot be nested.");
        let x = g2.params.slice(1, -1);
        if (x.length === 0) throw new Error("`@plugin` must have a path.");
        let V3 = {};
        for (let k3 of g2.nodes ?? []) {
          if (k3.kind !== "declaration") throw new Error(`Unexpected \`@plugin\` option:

${Fe([k3])}

\`@plugin\` options must be a flat list of declarations.`);
          if (k3.value === void 0) continue;
          let N3 = k3.value, F3 = u(N3, ",").map((R3) => {
            ...
            if (Number.isNaN(Number(R3))) {
              ...
              if (R3[0] === "{" && R3[R3.length - 1] === "}") throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${Fe([k3]).trim()}\` is not supported.

Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
            } else return Number(R3);
            return R3;
          });
          V3[k3.property] = F3.length === 1 ? F3[0] : F3;
        }
        s2.push([{ id: x, base: b3.base, reference: !!b3.reference }, Object.keys(V3).length > 0 ? V3 : null]), y3([]), u2 |= 4;
        return;
      }
      if (g2.name === "@config") {
        if (g2.nodes.length > 0) throw new Error("`@config` cannot have a body.");
        if (h2 !== null) throw new Error("`@config` cannot be nested.");
        p2.push({ id: g2.params.slice(1, -1), base: b3.base, reference: !!b3.reference }), y3([]), u2 |= 4;
        return;
      }
    }
  }), Lt(r);
  let m = r.resolveThemeValue;
  if (r.resolveThemeValue = function(h2) {
    return h2.startsWith("--") ? m(h2) : (u2 |= qt({ designSystem: r, base: t, ast: i, globs: l3, configs: [], pluginDetails: [] }), r.resolveThemeValue(h2));
  }, !s2.length && !p2.length) return 0;
  let [f2, d2] = await Promise.all([Promise.all(p2.map(async ({ id: g2, base: h2, reference: y3 }) => {
    let b3 = await e(g2, h2, "config");
    return { path: g2, base: b3.base, config: b3.module, reference: y3 };
  })), Promise.all(s2.map(async ([{ id: g2, base: h2, reference: y3 }, b3]) => {
    let x = await e(g2, h2, "plugin");
    return { path: g2, base: x.base, plugin: x.module, options: b3, reference: y3 };
  }))]);
  return u2 |= qt({ designSystem: r, base: t, ast: i, globs: l3, configs: f2, pluginDetails: d2 }), u2;
}
function qt({ designSystem: r, base: t, ast: i, globs: e, configs: l3, pluginDetails: u2 }) {
  let s2 = 0, m = [...u2.map((x) => {
    if (!x.options) return { config: { plugins: [x.plugin] }, base: x.base, reference: x.reference };
    if ("__isOptionsFunction" in x.plugin) return { config: { plugins: [x.plugin(x.options)] }, base: x.base, reference: x.reference };
    throw new Error(`The plugin "${x.path}" does not accept options`);
  }), ...l3], { resolvedConfig: f2 } = ze(r, [{ config: It(r.theme), base: t, reference: true }, ...m, { config: { plugins: [Mt] }, base: t, reference: true }]), { resolvedConfig: d2, replacedThemeKeys: g2 } = ze(r, m);
  r.resolveThemeValue = function(V3, k3) {
    let N3 = y3.theme(V3, k3);
    if (Array.isArray(N3) && N3.length === 2) return N3[0];
    if (Array.isArray(N3)) return N3.join(", ");
    if (typeof N3 == "string") return N3;
  };
  let h2 = { designSystem: r, ast: i, resolvedConfig: f2, featuresRef: { set current(x) {
    s2 |= x;
  } } }, y3 = Ue({ ...h2, referenceMode: false }), b3;
  for (let { handler: x, reference: V3 } of f2.plugins) V3 ? (b3 || (b3 = Ue({ ...h2, referenceMode: true })), x(b3)) : x(y3);
  if (kt(r, d2, g2), Ut(r, d2, g2), Wt(d2, r), Bt(d2, r), zt(d2, r), !r.theme.prefix && f2.prefix) {
    if (f2.prefix.endsWith("-") && (f2.prefix = f2.prefix.slice(0, -1), console.warn(`The prefix "${f2.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)), !zr.test(f2.prefix)) throw new Error(`The prefix "${f2.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
    r.theme.prefix = f2.prefix;
  }
  if (!r.important && f2.important === true && (r.important = true), typeof f2.important == "string") {
    let x = f2.important;
    w2(i, (V3, { replaceWith: k3, parent: N3 }) => {
      if (V3.kind === "at-rule" && !(V3.name !== "@tailwind" || V3.params !== "utilities")) return (N3 == null ? void 0 : N3.kind) === "rule" && N3.selector === x ? 2 : (k3(me(x, [V3])), 2);
    });
  }
  for (let x of f2.blocklist) r.invalidCandidates.add(x);
  for (let x of f2.content.files) {
    if ("raw" in x) throw new Error(`Error in the config file/plugin/preset. The \`content\` key contains a \`raw\` entry:
...
async function Zt(r, { base: t = "", loadModule: i = Wr, loadStylesheet: e = qr } = {}) {
  let l3 = 0;
  r = [We({ base: t }, r)], l3 |= await Fe2(r, t, e);
  let u2 = null, s2 = new P2(), p2 = [], m = [], f2 = null, d2 = null, g2 = [], h2 = [], y3 = [], b3 = [], x = null;
  w2(r, (k3, { parent: N3, replaceWith: F3, context: R3 }) => {
    if (k3.kind === "at-rule") {
      if (k3.name === "@tailwind" && (k3.params === "utilities" || k3.params.startsWith("utilities"))) {
        if (d2 !== null) {
          F3([]);
          return;
        }
        let D3 = u(k3.params, " ");
        for (let n of D3) if (n.startsWith("source(")) {
          let a = n.slice(7, -1);
          if (a === "none") {
            x = a;
            continue;
          ...
          x = { base: R3.sourceBase ?? R3.base, pattern: a.slice(1, -1) };
        }
        d2 = k3, l3 |= 16;
      }
      if (k3.name === "@utility") {
        if (N3 !== null) throw new Error("`@utility` cannot be nested.");
        if (k3.nodes.length === 0) throw new Error(`\`@utility ${k3.params}\` is empty. Utilities should include at least one property.`);
        let D3 = ot(k3);
        if (D3 === null) throw new Error(`\`@utility ${k3.params}\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter.`);
        m.push(D3);
      }
      if (k3.name === "@source") {
        if (k3.nodes.length > 0) throw new Error("`@source` cannot have a body.");
        if (N3 !== null) throw new Error("`@source` cannot be nested.");
        let D3 = false, n = false, a = k3.params;
        if (false, a[0] === '"' && a[a.length - 1] !== '"' || a[0] === "'" && a[a.length - 1] !== "'" || a[0] !== "'" && a[0] !== '"') throw new Error("`@source` paths must be quoted.");
        let c = a.slice(1, -1);
        if (false) {
          let w3 = D3 ? b3 : y3, v2 = u(c, " ");
          for (let $3 of v2) for (let E3 of Ne($3)) w3.push(E3);
        } else h2.push({ base: R3.base, pattern: c });
        F3([]);
        return;
      }
      if (k3.name === "@variant" && (N3 === null ? k3.nodes.length === 0 ? k3.name = "@custom-variant" : (w2(k3.nodes, (D3) => {
        if (D3.kind === "at-rule" && D3.name === "@slot") return k3.name = "@custom-variant", 2;
      }), k3.name === "@variant" && g2.push(k3)) : g2.push(k3)), k3.name === "@custom-variant") {
        if (N3 !== null) throw new Error("`@custom-variant` cannot be nested.");
        F3([]);
        let [D3, n] = u(k3.params, " ");
        if (!Ae2.test(D3)) throw new Error(`\`@custom-variant ${D3}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);
        if (k3.nodes.length > 0 && n) throw new Error(`\`@custom-variant ${D3}\` cannot have both a selector and a body.`);
        if (k3.nodes.length === 0) {
          if (!n) throw new Error(`\`@custom-variant ${D3}\` has no selector or body.`);
          let a = u(n.slice(1, -1), ",");
          if (a.length === 0 || a.some((v2) => v2.trim() === "")) throw new Error(`\`@custom-variant ${D3} (${a.join(",")})\` selector is invalid.`);
          let c = [], w3 = [];
          for (let v2 of a) v2 = v2.trim(), v2[0] === "@" ? c.push(v2) : w3.push(v2);
          p2.push((v2) => {
            v2.variants.static(D3, ($3) => {
              let E3 = [];
              w3.length > 0 && E3.push(me(w3.join(", "), $3.nodes));
              for (let C3 of c) E3.push(ee2(C3, $3.nodes));
              $3.nodes = E3;
            }, { compounds: ne3([...w3, ...c]) });
          });
          return;
          ...
          p2.push((a) => {
            a.variants.fromAst(D3, k3.nodes);
          });
          return;
        }
      }
      if (k3.name === "@media") {
        let D3 = u(k3.params, " "), n = [];
        for (let a of D3) if (a.startsWith("source(")) {
          let c = a.slice(7, -1);
          w2(k3.nodes, (w3, { replaceWith: v2 }) => {
            if (w3.kind === "at-rule" && w3.name === "@tailwind" && w3.params === "utilities") return w3.params += ` source(${c})`, v2([We({ sourceBase: R3.base }, [w3])]), 2;
          });
        } else if (a.startsWith("theme(")) {
          let c = a.slice(6, -1), w3 = c.includes("reference");
          w2(k3.nodes, (v2) => {
            if (v2.kind !== "at-rule") {
              if (w3) throw new Error('Files imported with `@import "…" theme(reference)` must only contain `@theme` blocks.\nUse `@reference "…";` instead.');
              return 0;
            }
            if (v2.name === "@theme") return v2.params += " " + c, 1;
          });
        } else if (a.startsWith("prefix(")) {
          let c = a.slice(7, -1);
          w2(k3.nodes, (w3) => {
            if (w3.kind === "at-rule" && w3.name === "@theme") return w3.params += ` prefix(${c})`, 1;
          });
        } else a === "important" ? u2 = true : a === "reference" ? k3.nodes = [We({ reference: true }, k3.nodes)] : n.push(a);
        n.length > 0 ? k3.params = n.join(" ") : D3.length > 0 && F3(k3.nodes);
      }
      if (k3.name === "@theme") {
        let [D3, n] = Jr(k3.params);
        if (R3.reference && (D3 |= 2), n) {
          if (!Br.test(n)) throw new Error(`The prefix "${n}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);
          s2.prefix = n;
        }
        return w2(k3.nodes, (a) => {
          if (a.kind === "at-rule" && a.name === "@keyframes") return s2.addKeyframes(a), 1;
          if (a.kind === "comment") return;
          if (a.kind === "declaration" && a.property.startsWith("--")) {
            s2.add($2(a.property), a.value ?? "", D3);
            return;
          }
          let c = Fe([V2(k3.name, k3.params, [a])]).split(`
`).map((w3, v2, $3) => `${v2 === 0 || v2 >= $3.length - 2 ? " " : ">"} ${w3}`).join(`
`);
          throw new Error(`\`@theme\` blocks must only contain custom properties or \`@keyframes\`.

${c}`);
        }), f2 ? F3([]) : (f2 = me(":root, :host", []), F3([f2])), 1;
      }
    }
  });
  let V3 = gt(s2);
  if (u2 && (V3.important = u2), b3.length > 0) for (let k3 of b3) V3.invalidCandidates.add(k3);
  l3 |= await Jt({ designSystem: V3, base: t, ast: r, loadModule: i, globs: h2 });
  for (let k3 of p2) k3(V3);
  for (let k3 of m) k3(V3);
  if (f2) {
    let k3 = [];
    for (let [F3, R3] of V3.theme.entries()) R3.options & 2 || k3.push(te2(W2(F3), R3.value));
    let N3 = V3.theme.getKeyframes();
    for (let F3 of N3) r.push(We({ theme: true }, [De([F3])]));
    f2.nodes = [We({ theme: true }, k3)];
  }
  if (d2) {
    let k3 = d2;
    k3.kind = "context", k3.context = {};
  }
  if (g2.length > 0) {
    for (let k3 of g2) {
      let N3 = me("&", k3.nodes), F3 = k3.params, R3 = V3.parseVariant(F3);
      if (R3 === null) throw new Error(`Cannot use \`@variant\` with unknown variant: ${F3}`);
      if (se2(N3, R3, V3.variants) === null) throw new Error(`Cannot use \`@variant\` with variant: ${F3}`);
      Object.assign(k3, N3);
    }
    l3 |= 32;
  }
  return l3 |= ae2(r, V3), l3 |= ge3(r, V3), w2(r, (k3, { replaceWith: N3 }) => {
    if (k3.kind === "at-rule") return k3.name === "@utility" && N3([]), 1;
  }), { designSystem: V3, ast: r, globs: h2, root: x, utilitiesNode: d2, features: l3, inlineCandidates: y3 };
}
async function Gr(r, t = {}) {
  let { designSystem: i, ast: e, globs: l3, root: u2, utilitiesNode: s2, features: p2, inlineCandidates: m } = await Zt(r, t);
  e.unshift(re2(`! tailwindcss v${Ye} | MIT License | https://tailwindcss.com `));
  function f2(b3) {
    i.invalidCandidates.add(b3);
  }
  let d2 = /* @__PURE__ */ new Set(), g2 = null, h2 = 0, y3 = false;
  for (let b3 of m) i.invalidCandidates.has(b3) || (d2.add(b3), y3 = true);
  return { globs: l3, root: u2, features: p2, build(b3) {
    if (p2 === 0) return r;
    if (!s2) return g2 ?? (g2 = Pe(e, i)), g2;
    let x = y3;
    y3 = false;
    let V3 = d2.size;
    for (let N3 of b3) i.invalidCandidates.has(N3) || (N3[0] === "-" && N3[1] === "-" ? i.theme.markUsedVariable(N3) : d2.add(N3), x || (x = d2.size !== V3));
    if (!x) return g2 ?? (g2 = Pe(e, i)), g2;
    let k3 = X3(d2, i, { onInvalidCandidate: f2 }).astNodes;
    return h2 === k3.length ? (g2 ?? (g2 = Pe(e, i)), g2) : (h2 = k3.length, s2.nodes = k3, g2 = Pe(e, i), g2);
  } };
}
async function Do(r, t = {}) {
  let i = Be(r), e = await Gr(i, t), l3 = i, u2 = r;
  return { ...e, build(s2) {
    let p2 = e.build(s2);
    return p2 === l3 || (u2 = Fe(p2), l3 = p2), u2;
  } };
}
async function Fo(r, t = {}) {
  return (await Zt(Be(r), t)).designSystem;
}
function Yr() {
...
export {
  de3 as Features,
  Fo as __unstable__loadDesignSystem,
  Do as compile,
  Gr as compileAst,
  Yr as default
};
